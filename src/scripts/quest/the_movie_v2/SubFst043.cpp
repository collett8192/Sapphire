...
if( actor == 2000143 && player.getQuestUI8AL( getId() ) != 2 ) { Scene00001( player ); }
//EOBJECT1, UI8AL, 2, -2, False
if( actor == 2000144 && player.getQuestUI8AL( getId() ) != 2 ) { Scene00002( player ); }
break;
}
case 255:{
Scene00003( player );
...
player.sendDebug( "questId: {}, calling Unknown:Scene00001 +2 ", getId() );
...
player.sendDebug( "questId: {}, calling Unknown:Scene00002 +2 ", getId() );
...
player.sendDebug( "questId: {}, calling [sub:Ok](2)Empty:Scene00098 EOBJECT1:UI8AL=-2, 2", getId() );
...
player.sendDebug( "questId: {}, calling [sub:Ok](1)Empty:Scene00100 EOBJECT0:UI8AL=-2, 2", getId() );
