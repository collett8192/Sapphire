...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1009984 || param2 == 1009984 ) // ACTOR1 = ALPHINAUD
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00002( player ); // Scene00002: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=ALPHINAUD
          }
          break;
        }
        if( param1 == 1006444 || param2 == 1006444 ) // ACTOR2 = DRILLEMONT
        {
      ...
      case 2:
      {
        if( param1 == 1006384 || param2 == 1006384 ) // ACTOR5 = HAURCHEFANT
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00006( player ); // Scene00006: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=HAURCHEFANT
          }
          break;
        }
        if( param1 == 1009977 || param2 == 1009977 ) // ACTOR6 = ALPHINAUD
        {
      ...
      case 255:
      {
        if( param1 == 1007603 || param2 == 1007603 ) // ACTOR7 = FORTEMPSGUARD00054
        {
          Scene00008( player ); // Scene00008: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=FORTEMPSGUARD00054
          // +Callback Scene00009: Normal(CutScene, FadeIn, QuestReward, QuestComplete, AutoFadeIn), id=unknown
          break;
        }
        if( param1 == 1006384 || param2 == 1006384 ) // ACTOR5 = HAURCHEFANT
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse416:65622 calling Scene00001: Normal(Talk, NpcDespawn, QuestAccept, TargetCanMove), id=MOENBRYDA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse416:65622 calling Scene00002: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=ALPHINAUD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00006( Entity::Player& player ) //SEQ_2: ACTOR5, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "GaiUse416:65622 calling Scene00006: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=HAURCHEFANT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
      player.setQuestBitFlag8( getId(), 1, true );
  ...
  void Scene00008( Entity::Player& player ) //SEQ_255: ACTOR7, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUse416:65622 calling Scene00008: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=FORTEMPSGUARD00054" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_255: ACTOR7, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUse416:65622 calling Scene00009: Normal(CutScene, FadeIn, QuestReward, QuestComplete, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
