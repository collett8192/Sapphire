...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002206 || param2 == 2002206 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4302140 || param2 == 4302140 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4302141 || param2 == 4302141 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 2002207 || param2 == 2002207 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4302152 || param2 == 4302152 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4302153 || param2 == 4302153 ) // ENEMY3 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4302154 || param2 == 4302154 ) // ENEMY4 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 255:
      {
        if( type != 2 ) Scene00006( player ); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=NPAHTAYUUN
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc413:66524 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=NPAHTAYUUN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc413:66524 calling Scene00003: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc413:66524 calling Scene00005: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
