...
//    static constexpr auto Actor1 = 1006644;
//    static constexpr auto Actor2 = 1006645;
//    static constexpr auto Actor3 = 1006646;
...
if( actor == 1006644 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR2, UI8BH, 1, -2, False
if( actor == 1006645 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00003( player ); }
break;
}
case 255:{
Scene00004( player );
