...
// Quest Script: SubSea104_00401
// Quest Name: Baiting Buzzards
// Quest ID: 65937
// Start NPC: 1003243
// End NPC: 1003243
...
class SubSea104 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto Enemy0 = 3926278;
//    static constexpr auto Enemy1 = 3926282;
//    static constexpr auto Eobject0 = 2001254;
//    static constexpr auto Item0 = 2000341;

  public:
    SubSea104() : Sapphire::ScriptAPI::EventScript( 65937 ){}; 
    ~SubSea104() = default; 
...
if( actor == 2001254 ) { Scene00001( player ); }
break;
}
case 255:{
Scene00002( player );
