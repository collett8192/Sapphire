...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( param1 == 1012698 || param2 == 1012698 ) // ACTOR0 = ESTINIEN
        {
        ...
        if( param1 == 1012697 || param2 == 1012697 ) // ACTOR1 = ALPHINAUD
        {
      ...
      case 1:
      {
        if( param1 == 1012720 || param2 == 1012720 ) // ACTOR2 = ALPHINAUD
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 2:
      {
        if( param1 == 1012583 || param2 == 1012583 ) // ACTOR3 = EMMANELLAIN
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
        ...
        if( param1 == 1013155 || param2 == 1013155 ) // ACTOR4 = HONOROIT
        {
          Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=HONOROIT
          break;
        }
        if( param1 == 1014107 || param2 == 1014107 ) // ACTOR5 = ALPHINAUD
        {
      ...
      case 3:
      {
        if( param1 == 1012709 || param2 == 1012709 ) // ACTOR6 = CID
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00008( player ); // Scene00008: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=CID
          }
          break;
        }
        if( param1 == 1012710 || param2 == 1012710 ) // ACTOR7 = BIGGS
        {
          Scene00009( player ); // Scene00009: Normal(Talk, TargetCanMove), id=BIGGS
          break;
        }
        if( param1 == 1012711 || param2 == 1012711 ) // ACTOR8 = WEDGE
        {
      ...
      case 255:
      {
        if( param1 == 1012714 || param2 == 1012714 ) // ACTOR9 = BIGGS
        {
        ...
        if( param1 == 1012713 || param2 == 1012713 ) // ACTOR10 = CID
        {
          Scene00016( player ); // Scene00016: Normal(Talk, TargetCanMove), id=CID
          break;
        }
        if( param1 == 1012715 || param2 == 1012715 ) // ACTOR11 = WEDGE
        {
          Scene00017( player ); // Scene00017: Normal(Talk, TargetCanMove), id=WEDGE
          break;
        }
        if( param1 == 1012716 || param2 == 1012716 ) // ACTOR12 = ALPHINAUD
        {
...
private:
  ...
  {
    player.sendDebug( "HeaVna328:67165 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove, ENpcBind), id=ESTINIEN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_3: ACTOR6, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "HeaVna328:67165 calling Scene00008: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=CID" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
      player.setQuestBitFlag8( getId(), 1, true );
  ...
  void Scene00009( Entity::Player& player ) //SEQ_3: ACTOR7, <No Var>, <No Flag>
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_3: ACTOR8, <No Var>, <No Flag>
  {
  ...
  {
    player.sendDebug( "HeaVna328:67165 calling Scene00014: Normal(CutScene, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00015( player );
    };
  ...
  void Scene00015( Entity::Player& player ) //SEQ_255: ACTOR9, <No Var>, <No Flag>
  {
    player.sendDebug( "HeaVna328:67165 calling Scene00015: Normal(FadeIn, QuestReward, QuestComplete, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
  ...
  void Scene00016( Entity::Player& player ) //SEQ_255: ACTOR10, <No Var>, <No Flag>
  {
  ...
  void Scene00017( Entity::Player& player ) //SEQ_255: ACTOR11, <No Var>, <No Flag>
  {
  ...
  void Scene00018( Entity::Player& player ) //SEQ_255: ACTOR12, <No Var>, <No Flag>
  {
