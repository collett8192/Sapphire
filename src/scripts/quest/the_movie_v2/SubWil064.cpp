...
//    static constexpr auto Eobject0 = 2000268;
...
if( actor == 2000268 ) { Scene00002( player ); }
//ENEMY0, UI8AL, 3, -2, False
if( actorId == 3785130 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00005( player ); }
//ENEMY1, UI8AL, 3, -2, False
if( actorId == 3785131 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00008( player ); }
//ENEMY2, UI8AL, 3, -2, False
if( actorId == 3785134 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00011( player ); }
break;
}
case 255:{
Scene00013( player );
...
player.sendDebug( "questId: {}, calling [sub:SkippedMsg](5)Empty:Scene00004 ENEMY0:UI8AL=-2, 3", getId() );
...
player.sendDebug( "questId: {}, calling [sub:SkippedMsg](8)Empty:Scene00007 ENEMY1:UI8AL=-2, 3", getId() );
...
player.sendDebug( "questId: {}, calling [sub:SkippedMsg](11)Empty:Scene00010 ENEMY2:UI8AL=-2, 3", getId() );
