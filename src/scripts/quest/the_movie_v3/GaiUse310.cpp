...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( actor == 1009414 || actorId == 1009414 ) // ACTOR0 = YDA
        {
          Scene00000( player ); // Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown
          // +Callback Scene00001: Normal(Talk, NpcDespawn, QuestAccept, TargetCanMove), id=YDA
        }
        if( actor == 1009106 || actorId == 1009106 ) // ACTOR1 = MAXIO
        {
      ...
      case 1:
      {
        if( actor == 1009118 || actorId == 1009118 ) // ACTOR2 = PAPALYMO
        {
        ...
        if( actor == 1009122 || actorId == 1009122 ) // ACTOR4 = DUMMYYSHTOLA01451
        {
          Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=DUMMYYSHTOLA01451
        }
        if( actor == 1009116 || actorId == 1009116 ) // ACTOR5 = YDA
        {
          Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=YDA
        }
        if( actor == 1009117 || actorId == 1009117 ) // ACTOR6 = MAXIO
        {
      ...
      case 3:
      {
        if( actor == 1009118 || actorId == 1009118 ) // ACTOR2 = PAPALYMO
        {
          ...
          {
            Scene00015( player ); // Scene00015: Normal(Talk, FadeIn, TargetCanMove), id=PAPALYMO
          }
        }
        if( actor == 1009116 || actorId == 1009116 ) // ACTOR5 = YDA
        {
      ...
      case 4:
      {
        if( actor == 4868023 || actorId == 4868023 ) // EVENTRANGE0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
        ...
        if( actor == 4868024 || actorId == 4868024 ) // ENEMY0 = unknown
        {
          // empty entry
        }
        if( actor == 1009123 || actorId == 1009123 ) // ACTOR7 = DUMMYYSHTOLA01451
        {
          Scene00021( player ); // Scene00021: Normal(None), id=unknown
          // +Callback Scene00022: Normal(Talk, TargetCanMove), id=DUMMYYSHTOLA01451
        }
        if( actor == 1009116 || actorId == 1009116 ) // ACTOR5 = YDA
        {
        ...
        if( actor == 1009119 || actorId == 1009119 ) // ACTOR8 = PAPALYMO
        {
          Scene00025( player ); // Scene00025: Normal(Talk, Message, TargetCanMove), id=PAPALYMO
        }
        if( actor == 1009120 || actorId == 1009120 ) // ACTOR9 = THANCRED
        {
        ...
        if( actor == 2004143 || actorId == 2004143 ) // EOBJECT0 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse310:66987 calling [BranchTrue]Scene00001: Normal(Talk, NpcDespawn, QuestAccept, TargetCanMove), id=YDA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse310:66987 calling [BranchTrue]Scene00014: Normal(TargetCanMove), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
  ...
  {
    player.sendDebug( "GaiUse310:66987 calling [BranchFalse]Scene00015: Normal(Talk, FadeIn, TargetCanMove), id=PAPALYMO" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
  ...
  {
    player.sendDebug( "GaiUse310:66987 calling [BranchTrue]Scene00022: Normal(Talk, TargetCanMove), id=DUMMYYSHTOLA01451" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
