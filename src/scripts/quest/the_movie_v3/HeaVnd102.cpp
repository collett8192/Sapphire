...
class HeaVnd102 : public Sapphire::ScriptAPI::QuestScript
{
public:
  HeaVnd102() : Sapphire::ScriptAPI::QuestScript( 67779 ){}; 
  ~HeaVnd102() = default; 
...
private:
  void onProgress( World::Quest& quest, Entity::Player& player, uint32_t type, uint64_t param1, uint32_t param2, uint32_t param3 )
  {
    switch( quest.getSeq() )
    {
      case 0:
      {
        if( param1 == 1016818 ) // ACTOR0 = ALPHINAUD
        {
          if( quest.getUI8AL() != 1 )
          {
        ...
        if( param1 == 1013040 ) // ACTOR1 = TATARU
        {
      ...
      case 1:
      {
        if( param1 == 1016881 ) // ACTOR2 = AYMERIC
        {
          if( quest.getUI8AL() != 1 )
          {
            Scene00004( quest, player ); // Scene00004: Normal(Talk, FadeIn, TargetCanMove, AutoFadeIn, ENpcBind), id=AYMERIC
          }
          break;
        }
        if( param1 == 1016824 ) // ACTOR3 = ALPHINAUD
        {
          Scene00005( quest, player ); // Scene00005: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1012326 ) // ACTOR4 = TATARU
        {
      ...
      case 255:
      {
        if( param1 == 1011935 ) // ACTOR5 = VIDOFNIR
        {
          Scene00007( quest, player ); // Scene00007: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove, AutoFadeIn), id=VIDOFNIR
          break;
        }
        if( param1 == 1012326 ) // ACTOR4 = TATARU
        {
...
private:
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove, AutoFadeIn), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00002: Normal(CutScene, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00003: Normal(Talk, TargetCanMove), id=TATARU" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00004: Normal(Talk, FadeIn, TargetCanMove, AutoFadeIn, ENpcBind), id=AYMERIC" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      quest.setUI8AL( 1 );
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00005: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00006: Normal(Talk, TargetCanMove), id=TATARU" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00007: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove, AutoFadeIn), id=VIDOFNIR" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      if( result.numOfResults > 0 && result.getResult( 0 ) == 1 )
      {
  ...
  {
    playerMgr().sendDebug( player, "HeaVnd102:67779 calling Scene00008: Normal(Talk, TargetCanMove), id=TATARU" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
