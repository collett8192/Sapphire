...
namespace Sapphire::Network::Packets::Server
{
  ...
  */
  struct FFXIVIpcPlayerSetup : FFXIVIpcBasePacket< PlayerSetup >
  {
    ...
    uint32_t unknownPvp110;
    uint32_t pvpExp;
    uint32_t pvpFrontlineOverallRanks[3];
    uint16_t levels[30];
    uint8_t unknown5_55a[178];
