...
class GaiUsa004 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto Actor1 = 1000766;
//    static constexpr auto Enemy0 = 4277224;
//    static constexpr auto Eobject0 = 2001902;
//    static constexpr auto Item0 = 2000571;
//    static constexpr auto Item1 = 2000831;

  public:
    GaiUsa004() : Sapphire::ScriptAPI::EventScript( 66246 ){}; 
    ~GaiUsa004() = default; 
...
if( actor == 2001902 ) { Scene00003( player ); }
//ENEMY0, UI8AL, 1, -2, False
if( actorId == 4277224 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00004( player ); }
break;
}
case 255:{
Scene00005( player );
...
player.sendDebug( "questId: {}, calling Inventory:Scene00003 EOBJECT0", getId() );
...
player.sendDebug( "questId: {}, calling Message:Scene00004 ENEMY0:UI8AL=-2, 1", getId() );
