...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 2002093 || actorId == 2002093 ) // EOBJECT0 = unknown
        {
        ...
        if( actor == 2002094 || actorId == 2002094 ) // EOBJECT1 = unknown
        {
        ...
        if( actor == 2002095 || actorId == 2002095 ) // EOBJECT2 = unknown
        {
      ...
      case 2:
      {
        if( actor == 2002259 || actorId == 2002259 ) // EOBJECT3 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
        ...
        if( actor == 4294858 || actorId == 4294858 ) // ENEMY0 = unknown
        {
          // empty entry
        }
        break;
...
private:
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=BLOEIDIN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling Scene00002: Normal(None), id=unknown" );
    Scene00003( player );
  }
  void Scene00003( Entity::Player& player )
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00003: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00005: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8BH( getId(), 1 );
      checkProgressSeq1( player );
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00007: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00009: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00011: Normal(Talk, TargetCanMove), id=BLOEIDIN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb409:66401 calling [BranchTrue]Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=BLAUGYBAL" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
