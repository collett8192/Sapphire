  ...
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        ...
        if( param1 == 1008271 || param2 == 1008271 ) // ACTOR3 = RAYAOSENNA
        {
          Scene00004( player ); // Scene00004: Normal(Talk, TargetCanMove), id=RAYAOSENNA
          break;
        }
        if( param1 == 1008272 || param2 == 1008272 ) // ACTOR4 = YDA
        {
          Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=YDA
          break;
        }
        if( param1 == 1008273 || param2 == 1008273 ) // ACTOR5 = PAPALYMO
        {
      ...
      case 255:
      {
        if( param1 == 1000692 || param2 == 1000692 ) // ACTOR7 = ESUMIYAN
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse115:66725 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=VORSAILE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
