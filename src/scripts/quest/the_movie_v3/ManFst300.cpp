...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 1003785 || actorId == 1003785 ) // ACTOR1 = TATARU
        {
        ...
        if( actor == 1004885 || actorId == 1004885 ) // ACTOR4 = STORMOFFICER
        {
      ...
      case 255:
      {
        if( actor == 1005122 || actorId == 1005122 ) // ACTOR24 = MINFILIA
        {
...
private:
  ...
  {
    player.sendDebug( "ManFst300:66047 calling [BranchTrue]Scene00001: Normal(CutScene, QuestAccept), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "ManFst300:66047 calling [BranchTrue]Scene00034: Normal(CutScene), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
