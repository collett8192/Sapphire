...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2005045 || param2 == 2005045 ) // EOBJECT0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00006( player ); // Scene00006: Normal(FadeIn, QuestGimmickReaction, AutoFadeIn), id=unknown
      ...
      case 255:
      {
        if( param1 == 1010897 || param2 == 1010897 ) // ACTOR5 = MINFILIA
        {
          Scene00013( player ); // Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove, AutoFadeIn), id=MINFILIA
          // +Callback Scene00014: Normal(Talk, CutScene, FadeIn, TargetCanMove), id=MINFILIA
          break;
        }
        if( param1 == 1010902 || param2 == 1010902 ) // ACTOR6 = THANCRED
        {
          Scene00015( player ); // Scene00015: Normal(Talk, TargetCanMove), id=THANCRED
          break;
        }
        if( param1 == 1010903 || param2 == 1010903 ) // ACTOR7 = YDA
        {
          Scene00016( player ); // Scene00016: Normal(Talk, TargetCanMove), id=YDA
          break;
        }
        if( param1 == 1010904 || param2 == 1010904 ) // ACTOR8 = PAPALYMO
        {
          Scene00017( player ); // Scene00017: Normal(Talk, TargetCanMove), id=PAPALYMO
          break;
        }
        if( param1 == 1010905 || param2 == 1010905 ) // ACTOR9 = YSHTOLA
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse508:65965 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00006( Entity::Player& player ) //SEQ_1: EOBJECT0, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "GaiUse508:65965 calling Scene00006: Normal(FadeIn, QuestGimmickReaction, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00007( player );
    };
  ...
  void Scene00007( Entity::Player& player ) //SEQ_1: EOBJECT0, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "GaiUse508:65965 calling Scene00007: Normal(CutScene), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_1: ACTOR1, <No Var>, <No Flag>
  {
  ...
  {
    player.sendDebug( "GaiUse508:65965 calling Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove, AutoFadeIn), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
  ...
  {
    player.sendDebug( "GaiUse508:65965 calling Scene00014: Normal(Talk, CutScene, FadeIn, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
