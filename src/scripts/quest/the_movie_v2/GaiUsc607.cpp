...
if( actor == 1003061 ) { Scene00002( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1000423 ) { Scene00003( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling Talk, QuestReward, QuestComplete:Scene00002 ACTOR1", getId() );
