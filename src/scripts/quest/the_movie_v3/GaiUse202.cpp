  ...
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        ...
        if( param1 == 1008702 || param2 == 1008702 ) // ACTOR1 = YSHTOLA
        {
      ...
      case 1:
      {
        if( param1 == 1002058 || param2 == 1002058 ) // ACTOR2 = FUFULUPA
        {
      ...
      case 2:
      {
        if( param1 == 2003561 || param2 == 2003561 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4620255 || param2 == 4620255 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4620256 || param2 == 4620256 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4620257 || param2 == 4620257 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4620258 || param2 == 4620258 ) // ENEMY3 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 1008598 || param2 == 1008598 ) // ACTOR3 = YSHTOLA
        {
          Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=YSHTOLA
          break;
        }
        if( param1 == 1008599 || param2 == 1008599 ) // ACTOR4 = THANCRED
        {
          Scene00009( player ); // Scene00009: Normal(Talk, TargetCanMove), id=THANCRED
          break;
        }
        if( param1 == 2003562 || param2 == 2003562 ) // EOBJECT1 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse202:66882 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=THANCRED" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00007( Entity::Player& player ) //SEQ_2: EOBJECT0, UI8AL = 4, Flag8(1)=True
  {
    player.sendDebug( "GaiUse202:66882 calling Scene00007: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_2: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUse202:66882 calling Scene00010: Normal(None), id=unknown" );
    checkProgressSeq2( player );
  }

  void Scene00011( Entity::Player& player ) //SEQ_3: ACTOR3, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00013( Entity::Player& player ) //SEQ_3: EOBJECT1, <No Var>, <No Flag>
  {
