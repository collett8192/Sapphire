...
class ManWil200 : public Sapphire::ScriptAPI::EventScript
{
  ...
  void onTalk( uint32_t eventId, Entity::Player& player, uint64_t actorId ) override
  {
    ...
    switch( player.getQuestSeq( getId() ) ){
      ...
      case 1:
      {
        if ( actor == Actor1 ) { Scene00002( player ); } // value 1
        if ( actor == Actor0 ) { Scene00003( player ); } // false
        break;
      }
      case 2:
      {
        if ( actor == Actor2 ) { Scene00004( player ); } // value 1
        //if ( actor == Eobject0 ) { Scene0000?( player ); } // false
        break;
      }
      case 3:
      {
        if ( actor == Eobject1 ) { Scene00007( player ); } // value 1
        //if ( actor == Actor2 ) { Scene0000?( player ); } // true
        //if ( actor == Eobject0 ) { Scene0000?( player ); } // false
        break;
      }
      case 4:
      {
        if ( actor == Actor3 ) { Scene00011( player ); } // value 1
        if ( actor == Actor4 ) { Scene00012( player ); } // true
        //if ( actor == Eobject2 ) { Scene000??( player ); } // false
        //if ( actor == Actor2 ) { Scene000??( player ); } // true
        break;
      }
      case 5:
      {
        //if ( actor == Actor5 ) { Scene00015( player ); } // value 1
        //if ( actor == Actor3 ) { Scene00015( player ); } // true
        //if ( actor == Eobject2 ) { Scene000??( player ); } // false
        //if ( actor == Actor2 ) { Scene000??( player ); } // true
        break;
      }
