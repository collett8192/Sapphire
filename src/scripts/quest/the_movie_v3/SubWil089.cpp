...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001374 || param2 == 2001374 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2001375 || param2 == 2001375 ) // EOBJECT1 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 4 )
          {
        ...
        if( param1 == 2001376 || param2 == 2001376 ) // EOBJECT2 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 4 )
          {
        ...
        if( param1 == 2001377 || param2 == 2001377 ) // EOBJECT3 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 4 )
          {
      ...
      case 255:
      {
        if( param1 == 1002064 || param2 == 1002064 ) // ACTOR1 = unknown
        {
...
private:
  ...
  void Scene00001( Entity::Player& player ) //SEQ_1: EOBJECT0, UI8AL = 4, Flag8(1)=True
  {
  ...
  void Scene00003( Entity::Player& player ) //SEQ_1: EOBJECT1, UI8AL = 4, Flag8(2)=True
  {
  ...
  void Scene00004( Entity::Player& player ) //SEQ_1: EOBJECT2, UI8AL = 4, Flag8(3)=True
  {
  ...
  void Scene00006( Entity::Player& player ) //SEQ_1: EOBJECT3, UI8AL = 4, Flag8(4)=True
  {
  ...
  {
    player.sendDebug( "SubWil089:65873 calling Scene00018: Normal(None), id=unknown" );
  }

  void Scene00021( Entity::Player& player ) //SEQ_255: EOBJECT3, <No Var>, <No Flag>
  {
    player.sendDebug( "SubWil089:65873 calling Scene00021: Normal(None), id=unknown" );
  }
};
