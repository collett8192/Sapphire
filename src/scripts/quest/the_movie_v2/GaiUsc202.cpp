...
if( actor == 1006497 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1006502 ) { Scene00004( player ); }
break;
}
case 3:{
//ACTOR2, UI8AL, 1, -1, False
if( actor == 1006501 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00005( player ); }
//ACTOR1, null, 0, -1, False
if( actor == 1006502 ) { Scene00007( player ); }
break;
}
case 255:{
//ACTOR0, null, 0, -1, False
if( actor == 1006497 ) { Scene00008( player ); }
//ACTOR2, null, 0, -1, False
if( actor == 1006501 ) { Scene00010( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling [sub:Execute](5)Talk:Scene00006 ACTOR2:UI8AL=-1, 1", getId() );
