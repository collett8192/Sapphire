...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001942 || param2 == 2001942 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2001943 || param2 == 2001943 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2001944 || param2 == 2001944 ) // EOBJECT2 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AUPHILIOT
        break;
      }
      default:
      {
