...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: NpcTrade(Talk), id=unknown
      ...
      case 255:
      {
        if( param1 == 1003475 || param2 == 1003475 ) // ACTOR1 = ROEHANTH
        {
          Scene00006( player ); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ROEHANTH
          break;
        }
        if( param1 == 2002554 || param2 == 2002554 ) // EOBJECT0 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "SubSea164:66686 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=ALYRLOE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "SubSea164:66686 calling Scene00003: Normal(Talk, TargetCanMove), id=ROEHANTH" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_255: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug( "SubSea164:66686 calling Scene00008: Normal(None), id=unknown" );
  }
};
