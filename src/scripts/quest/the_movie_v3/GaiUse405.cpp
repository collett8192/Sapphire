  ...
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 255:
      {
        ...
        {
          Scene00002( player ); // Scene00002: Normal(Talk, FadeIn, TargetCanMove, AutoFadeIn, ENpcBind), id=DRILLEMONT
...
private:
  ...
  {
    player.sendDebug( "GaiUse405:65598 calling Scene00001: Normal(Talk, NpcDespawn, QuestAccept, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse405:65598 calling Scene00002: Normal(Talk, FadeIn, TargetCanMove, AutoFadeIn, ENpcBind), id=DRILLEMONT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00003( player );
    };
  ...
  {
    player.sendDebug( "GaiUse405:65598 calling Scene00003: Normal(CutScene, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00004( player );
    };
  ...
  {
    player.sendDebug( "GaiUse405:65598 calling Scene00004: Normal(FadeIn, QuestReward, QuestComplete, TargetCanMove), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
