...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, NpcDespawn, TargetCanMove), id=CACTORA
        break;
      }
      case 2:
      {
        if( param1 == 1004914 || param2 == 1004914 ) // ACTOR0 = HAB
        {
        ...
        if( param1 == 1007632 || param2 == 1007632 ) // ACTOR2 = CACTORA
        {
      ...
      case 3:
      {
        if( param1 == 1006604 || param2 == 1006604 ) // ACTOR3 = CACTORB
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 4:
      {
        ...
        if( param1 == 1007633 || param2 == 1007633 ) // ACTOR4 = CACTORA
        {
      ...
      case 5:
      {
        if( param1 == 2002245 || param2 == 2002245 ) // EOBJECT0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 6:
      {
        if( param1 == 1006605 || param2 == 1006605 ) // ACTOR5 = CACTORC
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 255:
      {
        if( type != 2 ) Scene00017( player ); // Scene00017: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=HAB
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc710:66558 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=HAB" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00007( Entity::Player& player ) //SEQ_4: ACTOR0, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_4: ACTOR2, <No Var>, <No Flag>
  {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_4: ACTOR4, <No Var>, <No Flag>
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_5: EOBJECT0, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00011( Entity::Player& player ) //SEQ_5: EOBJECT0, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "GaiUsc710:66558 calling Scene00011: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
      player.setQuestBitFlag8( getId(), 1, true );
  ...
  void Scene00012( Entity::Player& player ) //SEQ_5: ACTOR2, <No Var>, <No Flag>
  {
  ...
  void Scene00013( Entity::Player& player ) //SEQ_5: ACTOR4, <No Var>, <No Flag>
  {
  ...
  void Scene00014( Entity::Player& player ) //SEQ_6: ACTOR5, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00015( Entity::Player& player ) //SEQ_6: ACTOR2, <No Var>, <No Flag>
  {
  ...
  void Scene00016( Entity::Player& player ) //SEQ_6: ACTOR4, <No Var>, <No Flag>
  {
