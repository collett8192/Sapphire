...
private:
  ...
  void Scene00006( Entity::Player& player ) //SEQ_1: EOBJECT2, UI8CH = 3, Flag8(3)=True
  {
  ...
  void Scene00007( Entity::Player& player ) //SEQ_1: EOBJECT2, UI8CH = 3, Flag8(3)=True
  {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_1: EOBJECT3, UI8CL = 1, Flag8(4)=True
  {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_1: EOBJECT3, UI8CL = 1, Flag8(4)=True
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_1: EOBJECT4, UI8BL = 1, Flag8(5)=True
  {
