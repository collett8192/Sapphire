...
// Quest Script: GaiUsb108_00827
// Quest Name: Heat of the Moment
// Quest ID: 66363
// Start NPC: 1006295
// End NPC: 1006295
...
//    static constexpr auto Actor0 = 1006295;
//    static constexpr auto Enemy0 = 4334161;
//    static constexpr auto Enemy1 = 4334162;
//    static constexpr auto Enemy2 = 17;
//    static constexpr auto Eobject0 = 2002048;
//    static constexpr auto Eobject1 = 2002047;
//    static constexpr auto Eobject2 = 2002049;
...
if( actor == 2002048 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, null, 0, -2, False
if( actor == 2002047 ) { Scene00003( player ); }
//EOBJECT2, null, 0, -2, False
if( actor == 2002049 ) { Scene00005( player ); }
break;
}
case 2:{
Scene00007( player );
...
player.sendDebug( "questId: {}, calling [sub:SkippedMsg](5)Empty:Scene00004 EOBJECT2", getId() );
