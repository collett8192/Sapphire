...
if( actor == 2002033 ) { Scene00002( player ); }
//if( actorId == 4291274 && player.getQuestUI8AL( getId() ) != 5 ) { Scene?????( player ); }
//if( actorId == 4291279 && player.getQuestUI8AL( getId() ) != 5 ) { Scene?????( player ); }
//if( actorId == 4291283 && player.getQuestUI8AL( getId() ) != 5 ) { Scene?????( player ); }
//if( actorId == 4291284 && player.getQuestUI8AL( getId() ) != 5 ) { Scene?????( player ); }
//if( actorId == 4291285 && player.getQuestUI8AL( getId() ) != 5 ) { Scene?????( player ); }
break;
}
case 255:{
Scene00004( player );
