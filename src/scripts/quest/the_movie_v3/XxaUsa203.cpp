...
class XxaUsa203 : public Sapphire::ScriptAPI::EventScript
{
public:
  XxaUsa203() : Sapphire::ScriptAPI::EventScript( 69395 ){}; 
  ~XxaUsa203() = default; 
    ...
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1002934 || param2 == 1002934 ) // ACTOR1 = NPCA
        {
          ...
          {
            Scene00002( player ); // Scene00002: Normal(Talk, Inventory, TargetCanMove), id=NPCA
            // +Callback Scene00003: Normal(Talk, NpcDespawn, TargetCanMove), id=NPCA
          }
          break;
        }
      ...
      case 255:
      {
        ...
        if( param1 == 1002935 || param2 == 1002935 ) // ACTOR2 = NPCB
        {
          Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=NPCB
          break;
        }
        break;
      }
