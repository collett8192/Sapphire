...
//    static constexpr auto Actor0 = 1006587;
...
if( actor == 1006587 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR0, null, 0, -2, False
if( actor == 1006587 ) { Scene00004( player ); }
break;
}
case 2:{
Scene00005( player );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](2)Talk:Scene00003 ACTOR0:UI8AL=-2, 1", getId() );
