...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002187 || param2 == 2002187 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4300168 || param2 == 4300168 ) // ENEMY0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002631 || param2 == 2002631 ) // EOBJECT1 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1006505 || param2 == 1006505 ) // ACTOR0 = AHLDUWIL
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc206:66501 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=AHLDUWIL" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc206:66501 calling Scene00003: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc206:66501 calling Scene00005: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
  ...
  {
    player.sendDebug( "GaiUsc206:66501 calling Scene00007: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AHLDUWIL" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_255: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsc206:66501 calling Scene00009: Normal(None), id=unknown" );
  }
};
