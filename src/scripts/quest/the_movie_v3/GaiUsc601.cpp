...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 2002231 || actorId == 2002231 ) // EOBJECT0 = unknown
        {
        ...
        if( actor == 2002233 || actorId == 2002233 ) // EOBJECT1 = unknown
        {
        ...
        if( actor == 2002230 || actorId == 2002230 ) // EOBJECT2 = unknown
        {
        ...
        if( actor == 4300120 || actorId == 4300120 ) // ENEMY0 = unknown
        {
          // empty entry
        }
        if( actor == 4300124 || actorId == 4300124 ) // ENEMY1 = unknown
        {
          // empty entry
        }
        if( actor == 4300125 || actorId == 4300125 ) // ENEMY2 = unknown
        {
          // empty entry
        }
        if( actor == 2002232 || actorId == 2002232 ) // EOBJECT3 = unknown
        {
        ...
        if( actor == 4300128 || actorId == 4300128 ) // ENEMY3 = unknown
        {
          // empty entry
        }
        if( actor == 2002234 || actorId == 2002234 ) // EOBJECT4 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=CID" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00003: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00005: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8BH( getId(), 1 );
      checkProgressSeq1( player );
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00007: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00009: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00011: Normal(QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc601:66537 calling [BranchTrue]Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=CID" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
