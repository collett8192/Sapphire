...
class SubCts801 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto Actor1 = 1005516;
//    static constexpr auto Actor2 = 1005515;
...
//    static constexpr auto UnlockImageHaircut = 138;
  ...
  public:
    SubCts801() : Sapphire::ScriptAPI::EventScript( 66746 ){}; 
    ~SubCts801() = default; 
