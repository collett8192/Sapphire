...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 4297079 || param2 == 4297079 ) // EVENTRANGE0 = unknown
        {
        ...
        if( param1 == 2002170 || param2 == 2002170 ) // EOBJECT0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
        ...
        if( param1 == 4297103 || param2 == 4297103 ) // ENEMY0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 4297104 || param2 == 4297104 ) // ENEMY1 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 4297106 || param2 == 4297106 ) // ENEMY2 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002322 || param2 == 2002322 ) // EOBJECT1 = unknown
        {
      ...
      case 2:
      {
        if( param1 == 2002590 || param2 == 2002590 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 1007631 || param2 == 1007631 ) // ACTOR1 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1006467 || param2 == 1006467 ) // ACTOR0 = ALPHINAUD
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc002:66475 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00002( Entity::Player& player ) //SEQ_1: EVENTRANGE0, UI8AL = 3, <No Flag>
  {
  ...
  {
    player.sendDebug( "GaiUsc002:66475 calling Scene00004: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
  ...
  {
    player.sendDebug( "GaiUsc002:66475 calling Scene00006: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }

  void Scene00007( Entity::Player& player ) //SEQ_1: EOBJECT1, <No Var>, <No Flag>
  {
  ...
  {
    player.sendDebug( "GaiUsc002:66475 calling Scene00008: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc002:66475 calling Scene00011: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
