...
private:
  ...
  void Scene00004( Entity::Player& player ) //SEQ_3: ACTOR1, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00005( Entity::Player& player ) //SEQ_3: ACTOR1, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00006( Entity::Player& player ) //SEQ_3: ACTOR2, UI8BH = 1, Flag8(2)=True
  {
  ...
  void Scene00007( Entity::Player& player ) //SEQ_3: ACTOR2, UI8BH = 1, Flag8(2)=True
  {
