...
class HeaVna706 : public Sapphire::ScriptAPI::QuestScript
{
public:
  HeaVna706() : Sapphire::ScriptAPI::QuestScript( 67204 ){}; 
  ~HeaVna706() = default; 
...
private:
  void onProgress( World::Quest& quest, Entity::Player& player, uint32_t type, uint64_t param1, uint32_t param2, uint32_t param3 )
  {
    switch( quest.getSeq() )
    {
      ...
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00002( quest, player ); // Scene00002: Normal(QuestReward, AutoFadeIn, SystemTalk), id=unknown
        // +Callback Scene00003: Normal(CutScene, FadeIn, QuestComplete, AutoFadeIn, SystemTalk), id=unknown
        break;
      }
      default:
      {
...
private:
  ...
  {
    playerMgr().sendDebug( player, "HeaVna706:67204 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
  ...
  {
    playerMgr().sendDebug( player, "HeaVna706:67204 calling Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=GUIDANCESYSTEM" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "HeaVna706:67204 calling Scene00002: Normal(QuestReward, AutoFadeIn, SystemTalk), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      if( result.numOfResults > 0 && result.getResult( 0 ) == 1 )
      {
  ...
  {
    playerMgr().sendDebug( player, "HeaVna706:67204 calling Scene00003: Normal(CutScene, FadeIn, QuestComplete, AutoFadeIn, SystemTalk), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
