...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002053 || param2 == 2002053 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4293262 || param2 == 4293262 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4293263 || param2 == 4293263 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 2002054 || param2 == 2002054 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4293264 || param2 == 4293264 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4293265 || param2 == 4293265 ) // ENEMY3 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 2002055 || param2 == 2002055 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 4293266 || param2 == 4293266 ) // ENEMY4 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4293267 || param2 == 4293267 ) // ENEMY5 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=FYRILSUNN
        break;
      }
      default:
      {
