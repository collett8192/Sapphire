...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006459 || param2 == 1006459 ) // ACTOR1 = unknown
        {
        ...
        if( param1 == 1006477 || param2 == 1006477 ) // ACTOR2 = LAURENCE
        {
          Scene00004( player ); // Scene00004: Normal(Talk, TargetCanMove), id=LAURENCE
          break;
        }
        break;
      }
      ...
      case 255:
      {
        if( param1 == 1006476 || param2 == 1006476 ) // ACTOR0 = DAIMBERT
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc007:66480 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=DAIMBERT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc007:66480 calling Scene00004: Normal(Talk, TargetCanMove), id=LAURENCE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
  ...
  {
    player.sendDebug( "GaiUsc007:66480 calling Scene00006: Normal(Talk, TargetCanMove), id=LAURENCE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
