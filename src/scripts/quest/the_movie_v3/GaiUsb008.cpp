...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002038 || param2 == 2002038 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4292783 || param2 == 4292783 ) // ENEMY0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 2194 || param2 == 2194 ) // ENEMY1 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002037 || param2 == 2002037 ) // EOBJECT1 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb008:66351 calling Scene00005: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
  ...
  {
    player.sendDebug( "GaiUsb008:66351 calling Scene00007: Normal(None), id=unknown" );
