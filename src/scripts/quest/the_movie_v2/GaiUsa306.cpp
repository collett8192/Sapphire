...
//    static constexpr auto Eobject0 = 2001949;
//    static constexpr auto Eobject1 = 2001950;
//    static constexpr auto Eobject2 = 2001951;
//    static constexpr auto Eobject3 = 2001952;
//    static constexpr auto Eobject4 = 2001953;
...
if( actor == 2001949 ) { Scene00002( player ); }
//EOBJECT1, null, 0, -2, False
if( actor == 2001950 ) { Scene00004( player ); }
//EOBJECT2, UI8AL, 1, -2, False
if( actor == 2001951 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00006( player ); }
//EOBJECT3, UI8BH, 1, -2, False
if( actor == 2001952 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00008( player ); }
//EOBJECT4, UI8BL, 1, -2, False
if( actor == 2001953 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00010( player ); }
break;
}
case 255:{
Scene00012( player );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](6)Empty:Scene00007 EOBJECT2:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](8)Empty:Scene00009 EOBJECT3:UI8BH=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](10)Empty:Scene00011 EOBJECT4:UI8BL=-2, 1", getId() );
