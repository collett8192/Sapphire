...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=NPC
        break;
      }
      //seq 2 event item ITEM0 = UI8BH max stack 1
      case 2:
      {
        if( param1 == 2002320 || param2 == 2002320 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 1006434 || param2 == 1006434 ) // ACTOR1 = NPC
        {
      ...
      case 4:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=HAURCHEFANT
        break;
      }
      ...
      case 5:
      {
        if( type != 2 ) Scene00009( player ); // Scene00009: Normal(Talk, TargetCanMove), id=FRANCEL
        break;
      }
...
private:
  ...
  {
    player.sendDebug( "GaiUsb808:66453 calling Scene00004: Normal(None), id=unknown" );
