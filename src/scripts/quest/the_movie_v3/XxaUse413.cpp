...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, FadeIn, TargetCanMove), id=ILBERD
        break;
      }
      case 2:
      {
        if( param1 == 1010037 || param2 == 1010037 ) // ACTOR2 = YUGIRI
        {
          ...
          {
            Scene00003( player ); // Scene00003: Normal(Talk, NpcDespawn, TargetCanMove, ENpcBind), id=YUGIRI
          }
          break;
        }
      ...
      case 4:
      {
        if( type != 2 ) Scene00006( player ); // Scene00006: Normal(Talk, NpcDespawn, TargetCanMove), id=YUGIRI
        break;
      }
      case 255:
      {
        if( type != 2 ) Scene00007( player ); // Scene00007: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=MINFILIA
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "XxaUse413:69423 calling Scene00003: Normal(Talk, NpcDespawn, TargetCanMove, ENpcBind), id=YUGIRI" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
