...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006290 || param2 == 1006290 ) // ACTOR1 = RIRIDESU
        {
        ...
        if( param1 == 1006291 || param2 == 1006291 ) // ACTOR2 = DRIFTINGCLOUD
        {
        ...
        if( param1 == 1006292 || param2 == 1006292 ) // ACTOR3 = SIDIMUND
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00005( player ); // Scene00005: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=UKHUBATIA
        break;
      }
      default:
      {
