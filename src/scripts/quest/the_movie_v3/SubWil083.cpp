...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 4143296 || param2 == 4143296 ) // EVENTRANGE0 = unknown
        {
        ...
        if( param1 == 352 || param2 == 352 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 353 || param2 == 353 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 255:
      {
        if( type != 2 ) Scene00003( player ); // Scene00003: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=unknown
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00001( Entity::Player& player ) //SEQ_1: EVENTRANGE0, UI8BL = 1, Flag8(1)=True
  {
  ...
  void Scene00002( Entity::Player& player ) //SEQ_1: EOBJECT0, <No Var>, <No Flag>
  {
