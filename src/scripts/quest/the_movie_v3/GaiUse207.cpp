...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1004096 || param2 == 1004096 ) // ACTOR1 = FOLCLIND
        {
        ...
        if( param1 == 1008626 || param2 == 1008626 ) // ACTOR0 = HOUZAN
        {
      ...
      case 2:
      {
        if( param1 == 1008611 || param2 == 1008611 ) // ACTOR2 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
        ...
        if( param1 == 1008626 || param2 == 1008626 ) // ACTOR0 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove, ENpcBind), id=unknown
          break;
        }
        break;
      }
      case 3:
      {
        if( param1 == 1008611 || param2 == 1008611 ) // ACTOR2 = HOUZAN
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=HOUZAN
            // +Callback Scene00008: Normal(Talk, ENpcBind), id=unknown
          }
          break;
        }
        if( param1 == 1008626 || param2 == 1008626 ) // ACTOR0 = HOUZAN
        ...
        if( param1 == 1008632 || param2 == 1008632 ) // ACTOR3 = GYOSHA01348
        {
      ...
      case 255:
      {
        if( param1 == 1008639 || param2 == 1008639 ) // ACTOR4 = HOUZAN
        {
          Scene00018( player ); // Scene00018: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=HOUZAN
          break;
        }
        if( param1 == 1008638 || param2 == 1008638 ) // ACTOR5 = HOUMEI
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse207:66887 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=HOUZAN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse207:66887 calling Scene00005: Normal(Talk, TargetCanMove, ENpcBind), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
  ...
  void Scene00008( Entity::Player& player ) //SEQ_3: ACTOR2, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "GaiUse207:66887 calling Scene00008: Normal(Talk, ENpcBind), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
      player.setQuestBitFlag8( getId(), 1, true );
  ...
  void Scene00009( Entity::Player& player ) //SEQ_3: ACTOR0, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUse207:66887 calling Scene00009: Normal(Talk, TargetCanMove), id=HOUZAN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
  ...
  void Scene00010( Entity::Player& player ) //SEQ_3: ACTOR3, <No Var>, <No Flag>
  {
  ...
  void Scene00011( Entity::Player& player ) //SEQ_4: ACTOR3, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00012( Entity::Player& player ) //SEQ_4: ACTOR0, <No Var>, <No Flag>
  {
  ...
  void Scene00014( Entity::Player& player ) //SEQ_5: ACTOR0, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00015( Entity::Player& player ) //SEQ_5: ACTOR0, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "GaiUse207:66887 calling Scene00015: Normal(Talk, NpcDespawn, TargetCanMove), id=HOUZAN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
      player.setQuestBitFlag8( getId(), 1, true );
  ...
  void Scene00016( Entity::Player& player ) //SEQ_5: ACTOR3, <No Var>, <No Flag>
  {
  ...
  void Scene00017( Entity::Player& player ) //SEQ_5: ACTOR2, <No Var>, <No Flag>
  {
  ...
  void Scene00018( Entity::Player& player ) //SEQ_255: ACTOR4, <No Var>, <No Flag>
  {
