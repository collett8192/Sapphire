...
class ManWil008 : public Sapphire::ScriptAPI::EventScript
{
public:
  ManWil008() : Sapphire::ScriptAPI::EventScript( 66177 ){}; 
  ~ManWil008() = default; 
...
private:
  ...
  {
    player.sendDebug( "ManWil008:66177 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
  ...
  {
    player.sendDebug( "ManWil008:66177 calling Scene00002: Normal(YesNo, TargetCanMove), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
  ...
  {
    player.sendDebug( "ManWil008:66177 calling Scene00003: Normal(Talk, TargetCanMove), id=MOMODI" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "ManWil008:66177 calling Scene00004: Normal(Talk, TargetCanMove), id=OWYNE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
  ...
  {
    player.sendDebug( "ManWil008:66177 calling Scene00005: Normal(Talk, TargetCanMove), id=SERENDIPITY" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "ManWil008:66177 calling Scene00006: NpcTrade(Talk, TargetCanMove), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
