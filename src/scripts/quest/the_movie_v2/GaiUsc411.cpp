...
//    static constexpr auto Actor1 = 1006534;
//    static constexpr auto Actor2 = 1006535;
...
//    static constexpr auto Eobject0 = 2002201;
//    static constexpr auto Eobject1 = 2002202;
...
if( actor == 2002201 ) { Scene00003( player ); }
//if( actorId == 4301976 && player.getQuestUI8AL( getId() ) != 4 ) { Scene?????( player ); }
//if( actorId == 4301980 && player.getQuestUI8AL( getId() ) != 4 ) { Scene?????( player ); }
//if( actorId == 4301981 && player.getQuestUI8AL( getId() ) != 4 ) { Scene?????( player ); }
//if( actorId == 4301983 && player.getQuestUI8AL( getId() ) != 4 ) { Scene?????( player ); }
break;
}
case 2:{
Scene00005( player );
...
player.sendDebug( "questId: {}, calling Talk, FadeOut:Scene00005 ", getId() );
