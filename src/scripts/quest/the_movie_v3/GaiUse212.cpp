  ...
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        ...
        if( param1 == 1008542 || param2 == 1008542 ) // ACTOR0 = MINFILIA
        {
      ...
      case 255:
      {
        if( param1 == 1006614 || param2 == 1006614 ) // ACTOR3 = FALKBRYDA
        {
        ...
        if( param1 == 1008676 || param2 == 1008676 ) // ACTOR4 = MINFILIA
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse212:66892 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
