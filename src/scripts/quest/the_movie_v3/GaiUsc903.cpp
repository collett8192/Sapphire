...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002255 || param2 == 2002255 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002253 || param2 == 2002253 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002254 || param2 == 2002254 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 4301884 || param2 == 4301884 ) // ENEMY0 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=RAFOLD
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc903:66574 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=RAFOLD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc903:66574 calling Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc903:66574 calling Scene00005: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc903:66574 calling Scene00007: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      checkProgressSeq1( player );
    };
