...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1003946 || param2 == 1003946 ) // ACTOR1 = ESMOUR
        {
        ...
        if( param1 == 1004575 || param2 == 1004575 ) // ACTOR2 = ZOZORU
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=BARRYN
        break;
      }
      default:
      {
