...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=BAENSYNG
        break;
      }
      ...
      case 3:
      {
        Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=WINEBURG
        break;
      }
      //seq 4 event item ITEM0 = UI8BH max stack 1
      case 4:
      {
        if( actor == 1003393 || actorId == 1003393 ) // ACTOR4 = AHLDFOET
        {
        ...
        if( actor == 1007721 || actorId == 1007721 ) // ACTOR3 = WINEBURG
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa301:66269 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=BUSCARRON" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa301:66269 calling [BranchTrue]Scene00004: Normal(Talk, TargetCanMove), id=KYOKYOROON" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa301:66269 calling [BranchTrue]Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=TETEROON" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
