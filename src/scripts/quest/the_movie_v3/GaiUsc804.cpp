...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 4309339 || param2 == 4309339 ) // EVENTRANGE0 = unknown
        {
        ...
        if( param1 == 4309336 || param2 == 4309336 ) // ENEMY0 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002458 || param2 == 2002458 ) // EOBJECT0 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00005( player ); // Scene00005: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=UJUGHAL
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc804:66564 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=UJUGHAL" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00002( Entity::Player& player ) //SEQ_1: EVENTRANGE0, UI8AL = 1, Flag8(1)=True
  {
  ...
  {
    player.sendDebug( "GaiUsc804:66564 calling Scene00004: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
