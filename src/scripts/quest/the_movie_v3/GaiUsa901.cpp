...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006253 || param2 == 1006253 ) // ACTOR1 = LAUGHINGFURY
        {
        ...
        if( param1 == 1006254 || param2 == 1006254 ) // ACTOR2 = VAVAPU
        {
        ...
        if( param1 == 1006258 || param2 == 1006258 ) // ACTOR3 = ADEMAR
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AELUUIN
        break;
      }
      default:
      {
