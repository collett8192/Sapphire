...
//    static constexpr auto Actor0 = 1002653;
//    static constexpr auto Actor1 = 1002654;
//    static constexpr auto Actor2 = 1002655;
//    static constexpr auto Actor3 = 1002656;
//    static constexpr auto Actor4 = 1002652;
...
if( actor == 1002654 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00001( player ); }
//ACTOR2, UI8AL, 3, -2, False
if( actor == 1002655 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00002( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1002656 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00003( player ); }
break;
}
case 255:{
Scene00004( player );
