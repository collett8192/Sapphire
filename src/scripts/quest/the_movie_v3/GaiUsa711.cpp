...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=NORAXIA
        break;
      }
      case 2:
      {
        if( type != 2 ) Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=MEDROD
        break;
      }
      case 3:
      {
        if( param1 == 1006241 || param2 == 1006241 ) // ACTOR3 = AIDEEN
        {
        ...
        if( param1 == 1006240 || param2 == 1006240 ) // ACTOR2 = MEDROD
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=MEDROD
...
private:
  ...
  void Scene00004( Entity::Player& player ) //SEQ_3: ACTOR3, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00005( Entity::Player& player ) //SEQ_3: ACTOR2, <No Var>, <No Flag>
  {
