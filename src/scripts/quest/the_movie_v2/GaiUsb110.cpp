...
// Quest Script: GaiUsb110_00829
// Quest Name: Mind Games
// Quest ID: 66365
// Start NPC: 1006287
// End NPC: 1006287
...
//    static constexpr auto Actor1 = 1006736;
//    static constexpr auto Enemy0 = 166;
//    static constexpr auto Enemy1 = 169;
//    static constexpr auto Enemy2 = 168;
...
case 1:{
//if( actorId == ENEMY0 or A3_40 == A0_37.ENEMY1 or A3_40 == A0_37.ENEMY2 && player.getQuestUI8AL( getId() ) != 3 ) { Scene?????( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1006736 ) { Scene00002( player ); }
break;
}
case 2:{
Scene00004( player );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](2)Talk:Scene00003 ACTOR1", getId() );
