...
//    static constexpr auto Actor2 = 1006679;
...
if( actor == 1006679 ) { Scene00003( player ); }
//if( actorId == 4278416 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
break;
}
case 4:{
Scene00004( player );
...
player.sendDebug( "questId: {}, calling Talk, Message:Scene00003 ACTOR2", getId() );
