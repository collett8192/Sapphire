...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1007637 || param2 == 1007637 ) // ACTOR1 = NPCA
        {
        ...
        if( param1 == 4297317 || param2 == 4297317 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
...
private:
  ...
  {
    player.sendDebug( "GaiUsc505:66529 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=WANDERINGBREEZE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
