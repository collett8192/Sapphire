...
// Quest Script: GaiUsc511_00999
// Quest Name: The Trickster of the Toll
// Quest ID: 66535
// Start NPC: 1006542
// End NPC: 1006542
...
//    static constexpr auto Actor0 = 1006542;
//    static constexpr auto Eobject0 = 2002214;
//    static constexpr auto Eobject1 = 2002215;
//    static constexpr auto Eobject2 = 2002216;
//    static constexpr auto Eobject3 = 2002217;
//    static constexpr auto Eobject4 = 2002218;
//    static constexpr auto Eobject5 = 2002219;
//    static constexpr auto Eobject6 = 2002220;
//    static constexpr auto Eobject7 = 2002221;
//    static constexpr auto EventActionSearch = 1;
//    static constexpr auto Item0 = 2000764;
...
if( actor == 2002214 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2002215 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//EOBJECT2, UI8BL, 1, -2, False
if( actor == 2002216 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00006( player ); }
//EOBJECT3, UI8CH, 1, -2, False
if( actor == 2002217 && player.getQuestUI8CH( getId() ) != 1 ) { Scene00008( player ); }
//EOBJECT4, UI8CL, 1, -2, False
if( actor == 2002218 && player.getQuestUI8CL( getId() ) != 1 ) { Scene00010( player ); }
//EOBJECT5, UI8DH, 1, -2, False
if( actor == 2002219 && player.getQuestUI8DH( getId() ) != 1 ) { Scene00012( player ); }
//EOBJECT6, UI8DL, 1, -2, False
if( actor == 2002220 && player.getQuestUI8DL( getId() ) != 1 ) { Scene00014( player ); }
//EOBJECT7, UI8EH, 1, -2, False
if( actor == 2002221 && player.getQuestUI8EH( getId() ) != 1 ) { Scene00016( player ); }
break;
}
case 255:{
Scene00018( player );
