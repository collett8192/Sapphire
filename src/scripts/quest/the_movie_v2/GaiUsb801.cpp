...
//    static constexpr auto Actor1 = 1006407;
//    static constexpr auto Actor2 = 1006408;
//    static constexpr auto Actor3 = 1006409;
//    static constexpr auto Actor4 = 1006410;
...
if( actor == 1006407 ) { Scene00002( player ); }
//if( actorId == 4293113 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1006408 ) { Scene00003( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1006409 ) { Scene00004( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1006410 ) { Scene00005( player ); }
break;
}
case 2:{
//ACTOR2, UI8AL, 3, -2, False
if( actor == 1006408 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00006( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1006409 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00008( player ); }
//ACTOR4, UI8AL, 3, -2, False
if( actor == 1006410 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00010( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1006407 ) { Scene00012( player ); }
break;
}
case 3:{
Scene00013( player );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](6)Talk:Scene00007 ACTOR2:UI8AL=-2, 3", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](8)Talk:Scene00009 ACTOR3:UI8AL=-2, 3", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](10)Talk:Scene00011 ACTOR4:UI8AL=-2, 3", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](13)Talk:Scene00014 ", getId() );
