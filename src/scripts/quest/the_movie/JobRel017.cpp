...
class JobRel017 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto AchievementRelic6 = 1081;
...
//    static constexpr auto Screenimage0 = 275;
  ...
  public:
    JobRel017() : Sapphire::ScriptAPI::EventScript( 66097 ){}; 
    ~JobRel017() = default; 
