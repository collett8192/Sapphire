...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001966 || param2 == 2001966 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4278211 || param2 == 4278211 ) // ENEMY0 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(Message, PopBNpc), id=unknown
          break;
        }
        if( param1 == 2001967 || param2 == 2001967 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4278213 || param2 == 4278213 ) // ENEMY1 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(Message, PopBNpc), id=unknown
          break;
        }
        if( param1 == 2001968 || param2 == 2001968 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 4329847 || param2 == 4329847 ) // ENEMY2 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=BALAN
        break;
      }
      default:
      {
