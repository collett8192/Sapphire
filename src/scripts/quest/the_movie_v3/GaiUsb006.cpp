...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006274 || param2 == 1006274 ) // ACTOR1 = BASHA
        {
        ...
        if( param1 == 2002036 || param2 == 2002036 ) // EOBJECT0 = unknown
        {
      ...
      case 2:
      {
        if( param1 == 1006275 || param2 == 1006275 ) // ACTOR2 = GALA
        {
        ...
        if( param1 == 1006276 || param2 == 1006276 ) // ACTOR3 = GALB
        {
          if( player.getQuestUI8AL( getId() ) != 4 )
          {
        ...
        if( param1 == 1006277 || param2 == 1006277 ) // ACTOR4 = GALC
        {
          if( player.getQuestUI8AL( getId() ) != 4 )
          {
        ...
        if( param1 == 1006278 || param2 == 1006278 ) // ACTOR5 = GALD
        {
          if( player.getQuestUI8AL( getId() ) != 4 )
          {
      ...
      case 255:
      {
        if( type != 2 ) Scene00012( player ); // Scene00012: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=GEGERUJU
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb006:66349 calling Scene00004: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }

  void Scene00005( Entity::Player& player ) //SEQ_2: ACTOR2, UI8AL = 4, Flag8(1)=True
  {
  ...
  void Scene00006( Entity::Player& player ) //SEQ_2: ACTOR3, UI8AL = 4, Flag8(2)=True
  {
  ...
  void Scene00007( Entity::Player& player ) //SEQ_2: ACTOR4, UI8AL = 4, Flag8(3)=True
  {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_2: ACTOR5, UI8AL = 4, Flag8(4)=True
  {
  ...
  {
    player.sendDebug( "GaiUsb006:66349 calling Scene00011: Normal(None), id=unknown" );
    checkProgressSeq2( player );
  }
