...
//    static constexpr auto Eobject0 = 2001920;
//    static constexpr auto Eobject1 = 2001921;
...
if( actor == 2001920 ) { Scene00003( player ); }
//if( actorId == 4278237 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//if( actorId == 4278233 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//EOBJECT1, null, 0, -2, False
if( actor == 2001921 ) { Scene00005( player ); }
//if( actorId == 4278251 && player.getQuestUI8BH( getId() ) != 1 ) { Scene?????( player ); }
break;
}
case 255:{
Scene00006( player );
