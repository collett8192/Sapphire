...
// Quest Script: SubFst060_00381
// Quest Name: Migrant Marauders
// Quest ID: 65917
// Start NPC: 1000741
// End NPC: 1000491
...
//    static constexpr auto Actor0 = 1000741;
//    static constexpr auto Actor1 = 1000491;
//    static constexpr auto Enemy0 = 3838969;
//    static constexpr auto Enemy1 = 3838970;
//    static constexpr auto Eobject0 = 2001006;
...
//    static constexpr auto Seq2Actor1 = 2;
...
if( actor == 2001006 ) { Scene00001( player ); }
//if( actorId == 3838969 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//if( actorId == 3838970 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
break;
}
case 255:{
Scene00002( player );
