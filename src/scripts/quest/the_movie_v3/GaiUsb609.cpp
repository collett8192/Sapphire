...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002112 || param2 == 2002112 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4290140 || param2 == 4290140 ) // ENEMY0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002623 || param2 == 2002623 ) // EOBJECT1 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002624 || param2 == 2002624 ) // EOBJECT2 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1006385 || param2 == 1006385 ) // ACTOR0 = DUVICAUROIX
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb609:66427 calling Scene00007: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
  ...
  void Scene00010( Entity::Player& player ) //SEQ_255: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsb609:66427 calling Scene00010: Normal(None), id=unknown" );
  }

  void Scene00012( Entity::Player& player ) //SEQ_255: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsb609:66427 calling Scene00012: Normal(None), id=unknown" );
  }
};
