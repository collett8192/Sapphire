...
// Quest Script: GaiUsa301_00733
// Quest Name: Never Forget
// Quest ID: 66269
// Start NPC: 1000590
// End NPC: 1006193
...
//    static constexpr auto Actor1 = 1003272;
//    static constexpr auto Actor2 = 1001208;
//    static constexpr auto Actor3 = 1007721;
//    static constexpr auto Actor4 = 1003393;
//    static constexpr auto Actor5 = 1006193;
//    static constexpr auto Item0 = 2000587;
//    static constexpr auto Ritem0 = 4772;
...
if( actor == 1003393 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00006( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1007721 ) { Scene00007( player ); }
break;
}
case 255:{
Scene00008( player );
...
player.sendDebug( "questId: {}, calling [sub:Execute](3)Talk:Scene00004 ", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00006 ACTOR4:UI8AL=-2, 1", getId() );
