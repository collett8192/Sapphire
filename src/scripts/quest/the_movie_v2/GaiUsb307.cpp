...
//    static constexpr auto Actor0 = 1006312;
//    static constexpr auto Actor1 = 1006305;
...
if( actor == 2002059 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2002060 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//EOBJECT2, UI8BL, 1, -2, False
if( actor == 2002061 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00006( player ); }
break;
}
case 255:{
Scene00008( player );
