...
//    static constexpr auto Actor1 = 1006498;
//    static constexpr auto Actor2 = 1006499;
//    static constexpr auto Actor3 = 1006500;
...
if( actor == 1006498 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00002( player ); }
//ACTOR2, UI8AL, 3, -2, False
if( actor == 1006499 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00003( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1006500 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00004( player ); }
break;
}
case 255:{
Scene00005( player );
