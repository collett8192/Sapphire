...
player.sendDebug( "questId: {}, calling [sub:Execute](3)Talk, FadeOut:Scene00004 ", getId() );
...
player.sendDebug( "questId: {}, calling [sub:Execute](5)Talk, FadeOut:Scene00006 ", getId() );
...
player.sendDebug( "questId: {}, calling NpcTrade:Scene00007 +1 ", getId() );
