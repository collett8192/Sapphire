...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=FAWKES
        break;
      }
      //seq 2 event item ITEM0 = UI8DL max stack 6
      case 2:
      {
        if( param1 == 2001969 || param2 == 2001969 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2001970 || param2 == 2001970 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4278319 || param2 == 4278319 ) // ENEMY0 = unknown
        {
          Scene00007( player ); // Scene00007: Normal(None), id=unknown
          break;
        }
        if( param1 == 2001971 || param2 == 2001971 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 2001972 || param2 == 2001972 ) // EOBJECT3 = unknown
        {
        ...
        if( param1 == 4278320 || param2 == 4278320 ) // ENEMY1 = unknown
        {
          Scene00011( player ); // Scene00011: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002269 || param2 == 2002269 ) // EOBJECT4 = unknown
        {
        ...
        if( param1 == 2001973 || param2 == 2001973 ) // EOBJECT5 = unknown
        {
        ...
        if( param1 == 4278321 || param2 == 4278321 ) // ENEMY2 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa606:66304 calling Scene00004: Normal(None), id=unknown" );
    player.setQuestUI8AL( getId(), 1 );
    player.setQuestBitFlag8( getId(), 1, true );
    checkProgressSeq2( player );
  }

  void Scene00006( Entity::Player& player ) //SEQ_2: EOBJECT1, UI8CH = 1, Flag8(2)=True
  {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_2: EOBJECT2, UI8BH = 1, Flag8(3)=True
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_2: EOBJECT3, UI8CL = 1, Flag8(4)=True
  {
  ...
  void Scene00012( Entity::Player& player ) //SEQ_2: EOBJECT4, UI8BL = 1, Flag8(5)=True
  {
    player.sendDebug( "GaiUsa606:66304 calling Scene00012: Normal(None), id=unknown" );
    player.setQuestUI8BL( getId(), 1 );
    player.setQuestBitFlag8( getId(), 5, true );
    checkProgressSeq2( player );
  }

  void Scene00013( Entity::Player& player ) //SEQ_2: EOBJECT5, UI8DH = 1, Flag8(6)=True
  {
  ...
  void Scene00014( Entity::Player& player ) //SEQ_2: ENEMY2, <No Var>, <No Flag>
  {
