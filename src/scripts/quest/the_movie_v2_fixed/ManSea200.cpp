...
// Quest Script: ManSea200_00546
// Quest Name: The Lominsan Envoy
// Quest ID: 66082
// Start NPC: 1002694
// End NPC: 1001821
...
//    static constexpr auto Actor0 = 1002694;
//    static constexpr auto Actor1 = 1001029;
//    static constexpr auto Actor10 = 1001821;
//    static constexpr auto Actor2 = 1000972;
//    static constexpr auto Actor3 = 1002695;
//    static constexpr auto Actor4 = 1002830;
//    static constexpr auto Actor5 = 1000109;
//    static constexpr auto Actor6 = 1000460;
//    static constexpr auto Actor7 = 1000106;
//    static constexpr auto Actor8 = 1004336;
//    static constexpr auto Actor9 = 1004434;
//    static constexpr auto Eobject0 = 2001675;
//    static constexpr auto Eobject1 = 2001668;
//    static constexpr auto Eobject2 = 2001678;
//    static constexpr auto Eobject3 = 2001671;
//    static constexpr auto Eobject4 = 2001688;
//    static constexpr auto EventActionWaitingShor = 11;
//    static constexpr auto Item0 = 2000458;
//    static constexpr auto Item1 = 2000459;
//    static constexpr auto NcutEvent001 = 212;
//    static constexpr auto NcutEvent002 = 213;
//    static constexpr auto NcutEvent003 = 214;
//    static constexpr auto NcutEvent004 = 154;
//    static constexpr auto NcutEvent005 = 67;
//    static constexpr auto NcutEvent006 = 99;
//    static constexpr auto NcutEvent007 = 156;
//    static constexpr auto NcutEvent008 = 100;
//    static constexpr auto NcutEvent009 = 159;
//    static constexpr auto NcutEvent010 = 232;
//    static constexpr auto NcutEvent011 = 231;
...
//    static constexpr auto Poprange0 = 4146949;
//    static constexpr auto Poprange1 = 4103402;
//    static constexpr auto Poprange2 = 4102803;
//    static constexpr auto Poprange3 = 4103382;
//    static constexpr auto Poprange4 = 4103392;
...
case 0:{
//if( actor == 1002694 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
//if( actor == 1001029 ) { Scene?????( player ); }
Scene00000( player );
break;
}
case 1:{
...
if( actor == 1002695 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00004( player ); }
//EOBJECT0, null, 0, -2, False
//if( actor == 2001675 ) { Scene00005( player ); }
break;
}
case 3:{
//EOBJECT1, UI8AL, 1, -2, False
if( actor == 2001668 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00007( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1002695 ) { Scene00007( player ); }
//EOBJECT0, null, 0, -2, False
//if( actor == 2001675 ) { Scene00009( player ); }
break;
}
case 4:{
//ACTOR4, UI8AL, 1, -2, False
if( actor == 1002830 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00011( player ); }
//ACTOR5, null, 0, -2, False
//if( actor == 1000109 ) { Scene00011( player ); }
//EOBJECT2, null, 0, -2, False
//if( actor == 2001678 ) { Scene00012( player ); }
//ACTOR3, null, 0, -2, False
//if( actor == 1002695 ) { Scene00013( player ); }
break;
}
case 5:{
//ACTOR6, UI8AL, 1, -2, False
if( actor == 1000460 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00016( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1002830 ) { Scene00020( player ); }
//EOBJECT2, null, 0, -2, False
//if( actor == 2001678 ) { Scene00018( player ); }
//ACTOR3, null, 0, -2, False
//if( actor == 1002695 ) { Scene00019( player ); }
break;
}
case 6:{
//ACTOR7, UI8AL, 1, -2, False
if( actor == 1000106 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00024( player ); }
//EOBJECT2, null, 0, -2, False
//if( actor == 2001678 ) { Scene00021( player ); }
//ACTOR3, null, 0, -2, False
//if( actor == 1002695 ) { Scene00022( player ); }
break;
}
case 7:{
//EOBJECT3, UI8AL, 1, -2, False
if( actor == 2001671 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00029( player ); }
//ACTOR7, null, 0, -2, False
if( actor == 1000106 ) { Scene00029( player ); }
//EOBJECT2, null, 0, -2, False
//if( actor == 2001678 ) { Scene00026( player ); }
//ACTOR3, null, 0, -2, False
//if( actor == 1002695 ) { Scene00028( player ); }
break;
}
case 8:{
...
//if( actor == 2001688 ) { Scene00032( player ); }
//ACTOR3, null, 0, -2, False
//if( actor == 1002695 ) { Scene00033( player ); }
//ACTOR7, null, 0, -2, False
//if( actor == 1000106 ) { Scene00035( player ); }
break;
}
case 255:{
...
//EOBJECT4, null, 0, -2, False
//if( actor == 2001688 ) { Scene00047( player ); }
//ACTOR3, null, 0, -2, False
//if( actor == 1002695 ) { Scene00048( player ); }
//ACTOR7, null, 0, -2, False
//if( actor == 1000106 ) { Scene00049( player ); }
break;
}
