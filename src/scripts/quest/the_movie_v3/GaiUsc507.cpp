...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 3:
      {
        if( actor == 2002212 || actorId == 2002212 ) // EOBJECT0 = unknown
        {
        ...
        if( actor == 4299869 || actorId == 4299869 ) // ENEMY3 = unknown
        {
          // empty entry
        }
        break;
...
private:
  ...
  {
    player.sendDebug( "GaiUsc507:66531 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=WANDERINGBREEZE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc507:66531 calling [BranchTrue]Scene00003: Normal(Talk, TargetCanMove), id=WANDERINGBREEZE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc507:66531 calling [BranchTrue]Scene00007: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=WANDERINGBREEZE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
  ...
  {
    player.sendDebug( "GaiUsc507:66531 calling Scene00008: Normal(None), id=unknown" );
    Scene00009( player );
  }
  void Scene00009( Entity::Player& player )
  {
    player.sendDebug( "GaiUsc507:66531 calling [BranchTrue]Scene00009: Normal(None), id=unknown" );
  }
};
