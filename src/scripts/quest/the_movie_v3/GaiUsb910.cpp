...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002164 || param2 == 2002164 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4293228 || param2 == 4293228 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4293229 || param2 == 4293229 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 255:
      {
        if( param1 == 1006457 || param2 == 1006457 ) // ACTOR0 = FAUCILLIEN
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb910:66469 calling Scene00006: Normal(None), id=unknown" );
  }
};
