...
private:
  ...
  {
    player.sendDebug( "GaiUsb812:66457 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=SIBOLD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb812:66457 calling [BranchTrue]Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb812:66457 calling Scene00005: Normal(None), id=unknown" );
    Scene00006( player );
  }
  void Scene00006( Entity::Player& player )
  {
    player.sendDebug( "GaiUsb812:66457 calling [BranchTrue]Scene00006: Normal(None), id=unknown" );
  }
};
