...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 1012334 || actorId == 1012334 ) // ACTOR1 = ARTOIREL
        {
      ...
      case 2:
      {
        Scene00004( player ); // Scene00004: Normal(Talk, NpcDespawn, TargetCanMove), id=ARTOIREL
        break;
      }
      case 3:
      {
        Scene00005( player ); // Scene00005: Normal(Talk, NpcDespawn, TargetCanMove), id=ARTOIREL
        break;
      }
      case 4:
      {
        if( actor == 5856600 || actorId == 5856600 ) // EVENTRANGE0 = unknown
        {
        ...
        if( actor == 5856587 || actorId == 5856587 ) // ENEMY0 = unknown
        {
          // empty entry
        }
        if( actor == 5856588 || actorId == 5856588 ) // ENEMY1 = unknown
        {
          // empty entry
        }
        if( actor == 5856589 || actorId == 5856589 ) // ENEMY2 = unknown
        {
          // empty entry
        }
        if( actor == 1012339 || actorId == 1012339 ) // ACTOR4 = unknown
        {
          Scene00007( player ); // Scene00007: Normal(None), id=unknown
        }
        if( actor == 2005406 || actorId == 2005406 ) // EOBJECT0 = unknown
        {
          Scene00008( player ); // Scene00008: Normal(None), id=unknown
          // +Callback Scene00009: Normal(None), id=unknown
        }
        if( actor == 1012340 || actorId == 1012340 ) // ACTOR5 = ARTOIREL
        {
      ...
      case 255:
      {
        ...
        // +Callback Scene00014: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=KIGHT01583
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "HeaVna108:67123 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=REDWALD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "HeaVna108:67123 calling [BranchTrue]Scene00009: Normal(None), id=unknown" );
    checkProgressSeq4( player );
  }
  ...
  {
    player.sendDebug( "HeaVna108:67123 calling [BranchTrue]Scene00011: Normal(None), id=unknown" );
  }
  ...
  {
    player.sendDebug( "HeaVna108:67123 calling [BranchTrue]Scene00013: Normal(None), id=unknown" );
    Scene00014( player );
  }
  void Scene00014( Entity::Player& player )
  {
    player.sendDebug( "HeaVna108:67123 calling [BranchChain]Scene00014: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=KIGHT01583" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
