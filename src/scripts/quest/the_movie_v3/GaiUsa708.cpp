...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002549 || param2 == 2002549 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4284978 || param2 == 4284978 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 2002550 || param2 == 2002550 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4284980 || param2 == 4284980 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 57 || param2 == 57 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 1006732 || param2 == 1006732 ) // ACTOR1 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006733 || param2 == 1006733 ) // ACTOR2 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1006227 || param2 == 1006227 ) // ACTOR0 = AMELOT
        {
...
private:
  ...
  void Scene00002( Entity::Player& player ) //SEQ_1: EOBJECT0, UI8BH = 1, Flag8(1)=True
  {
  ...
  void Scene00004( Entity::Player& player ) //SEQ_1: EOBJECT1, UI8BL = 1, Flag8(2)=True
  {
  ...
  void Scene00005( Entity::Player& player ) //SEQ_1: EOBJECT1, UI8BL = 1, Flag8(2)=True
  {
  ...
  {
    player.sendDebug( "GaiUsa708:66317 calling Scene00012: Normal(None), id=unknown" );
  }
};
