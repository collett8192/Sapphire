...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006485 || param2 == 1006485 ) // ACTOR1 = NPCA
        {
        ...
        if( param1 == 1006486 || param2 == 1006486 ) // ACTOR2 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006487 || param2 == 1006487 ) // ACTOR3 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1006484 || param2 == 1006484 ) // ACTOR0 = MEURISE
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc013:66486 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=MEURISE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc013:66486 calling Scene00003: Normal(Talk, TargetCanMove), id=NPCA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
