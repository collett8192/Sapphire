...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( param1 == 2002097 || param2 == 2002097 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002098 || param2 == 2002098 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002099 || param2 == 2002099 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 2002100 || param2 == 2002100 ) // EOBJECT3 = unknown
        {
      ...
      case 3:
      {
        if( type != 2 ) Scene00012( player ); // Scene00012: Normal(Talk, TargetCanMove), id=ZAZAWAKA
        break;
      }
      //seq 255 event item ITEM0 = UI8BH max stack 4
      case 255:
      {
        if( type != 2 ) Scene00013( player ); // Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ILIUD
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00007( Entity::Player& player ) //SEQ_2: EOBJECT1, UI8BH = 1, Flag8(2)=True
  {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_2: EOBJECT2, UI8BL = 1, Flag8(3)=True
  {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_2: EOBJECT2, UI8BL = 1, Flag8(3)=True
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_2: EOBJECT3, UI8CH = 1, Flag8(4)=True
  {
  ...
  void Scene00011( Entity::Player& player ) //SEQ_2: EOBJECT3, UI8CH = 1, Flag8(4)=True
  {
