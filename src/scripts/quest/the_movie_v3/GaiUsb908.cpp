...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002159 || param2 == 2002159 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002160 || param2 == 2002160 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002161 || param2 == 2002161 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 2002162 || param2 == 2002162 ) // EOBJECT3 = unknown
        {
        ...
        if( param1 == 2002163 || param2 == 2002163 ) // EOBJECT4 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00012( player ); // Scene00012: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=CHAUNOLLET
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb908:66467 calling Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb908:66467 calling Scene00005: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb908:66467 calling Scene00007: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb908:66467 calling Scene00009: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb908:66467 calling Scene00011: Normal(None), id=unknown" );
