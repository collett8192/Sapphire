...
//    static constexpr auto Actor1 = 1006506;
//    static constexpr auto Actor2 = 1007639;
//    static constexpr auto Actor3 = 1006505;
...
if( actor == 1006506 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00002( player ); }
//ACTOR2, UI8AL, 3, -2, False
if( actor == 1007639 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00003( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1006505 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00004( player ); }
break;
}
case 255:{
Scene00005( player );
