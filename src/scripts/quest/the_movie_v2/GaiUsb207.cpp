...
// Quest Script: GaiUsb207_00838
// Quest Name: To You from Failing Hands We Throw
// Quest ID: 66374
// Start NPC: 1006270
// End NPC: 1006270
...
//    static constexpr auto Actor0 = 1006270;
//    static constexpr auto Actor1 = 5010000;
//    static constexpr auto Eobject0 = 2002547;
//    static constexpr auto Eobject1 = 2002056;
//    static constexpr auto Eobject2 = 2002057;
//    static constexpr auto Eobject3 = 2002058;
//    static constexpr auto Eventrange0 = 4325251;
//    static constexpr auto EventActionSearchMiddle = 3;
//    static constexpr auto Item0 = 2000652;
...
if( actor == 2002056 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00004( player ); }
//EOBJECT2, UI8AL, 3, -2, False
if( actor == 2002057 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00006( player ); }
//EOBJECT3, UI8AL, 3, -2, False
if( actor == 2002058 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00008( player ); }
break;
}
case 255:{
Scene00010( player );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](8)Empty:Scene00009 EOBJECT3:UI8AL=-2, 3", getId() );
