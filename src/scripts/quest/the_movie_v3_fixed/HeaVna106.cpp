...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1011241 || param2 == 1011241 ) // ACTOR1 = THIERREMONT
        {
        ...
        if( param1 == 1011236 || param2 == 1011236 ) // ACTOR0 = ROTHE
        {
      ...
      case 2:
      {
        if( param1 == 4803 || param2 == 4803 ) // ENEMY0 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "HeaVna106:67121 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=ROTHE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "HeaVna106:67121 calling Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=THIERREMONT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
