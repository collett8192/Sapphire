...
// Quest Script: GaiUse102_01176
// Quest Name: Moving On
// Quest ID: 66712
// Start NPC: 1006693
// End NPC: 1006355
...
//    static constexpr auto Actor3 = 1007740;
...
if( actor == 1006355 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1007740 ) { Scene00004( player ); }
break;
}
case 3:{
Scene00005( player );
...
if( actor == 1006355 ) { Scene00006( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1007740 ) { Scene00007( player ); }
break;
}
