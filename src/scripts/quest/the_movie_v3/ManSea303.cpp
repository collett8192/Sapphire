...
private:
  ...
  {
    player.sendDebug( "ManSea303:66220 calling Scene00000: Normal(QuestOffer, QuestAccept, TargetCanMove), id=unknown" );
  ...
  {
    player.sendDebug( "ManSea303:66220 calling Scene00001: Normal(CutScene, FadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
