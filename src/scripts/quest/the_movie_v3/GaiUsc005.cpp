...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 1006445 || actorId == 1006445 ) // ACTOR1 = BENEDICT
        {
        ...
        if( actor == 1006451 || actorId == 1006451 ) // ACTOR2 = IGNEMORTEL
        {
        ...
        if( actor == 2002176 || actorId == 2002176 ) // EOBJECT0 = unknown
        {
        ...
        if( actor == 2002177 || actorId == 2002177 ) // EOBJECT1 = unknown
        {
        ...
        if( actor == 2002178 || actorId == 2002178 ) // EOBJECT2 = unknown
        {
      ...
      case 255:
      {
        Scene00012( player ); // Scene00012: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=LIAUTROIX
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc005:66478 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=LIAUTROIX" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc005:66478 calling Scene00004: Normal(None), id=unknown" );
    Scene00005( player );
  }
  void Scene00005( Entity::Player& player )
  {
    player.sendDebug( "GaiUsc005:66478 calling [BranchTrue]Scene00005: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc005:66478 calling Scene00006: Normal(None), id=unknown" );
    Scene00007( player );
  }
  void Scene00007( Entity::Player& player )
  {
    player.sendDebug( "GaiUsc005:66478 calling [BranchTrue]Scene00007: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc005:66478 calling Scene00008: Normal(None), id=unknown" );
    Scene00009( player );
  }
  void Scene00009( Entity::Player& player )
  {
    player.sendDebug( "GaiUsc005:66478 calling [BranchTrue]Scene00009: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc005:66478 calling [BranchTrue]Scene00011: Normal(Talk, TargetCanMove), id=TUATKK" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
