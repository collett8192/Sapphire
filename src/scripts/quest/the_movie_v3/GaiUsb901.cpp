...
class GaiUsb901 : public Sapphire::ScriptAPI::EventScript
{
public:
  GaiUsb901() : Sapphire::ScriptAPI::EventScript( 66460 ){}; 
  ~GaiUsb901() = default; 
...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=ALBOISE
        break;
      }
      ...
      case 2:
      {
        Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=ASTIDIEN
        break;
      }
      ...
      case 3:
      {
        Scene00004( player ); // Scene00004: Normal(Talk, TargetCanMove), id=GOUDERNOUX
        break;
      }
...
private:
  ...
  {
    player.sendDebug( "GaiUsb901:66460 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=BRUNADIER" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb901:66460 calling [BranchTrue]Scene00006: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=DRILLEMONT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
