...
//    static constexpr auto Eobject0 = 2002044;
//    static constexpr auto Eobject1 = 2002045;
...
if( actor == 2002045 ) { Scene00003( player ); }
//ENEMY0, UI8AL, 1, -2, False
if( actorId == 4293187 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00005( player ); }
//EOBJECT0, null, 0, -2, False
if( actor == 2002044 ) { Scene00007( player ); }
break;
}
case 255:{
Scene00008( player );
