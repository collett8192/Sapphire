...
if( actor == 1008628 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
...
if( actor == 1008635 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00004( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1008636 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00005( player ); }
//ACTOR4, UI8AL, 3, -2, False
if( actor == 1008637 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00006( player ); }
//ACTOR0, null, 0, -2, False
