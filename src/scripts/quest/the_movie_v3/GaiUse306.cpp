...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 255:
      {
        if( param1 == 1008579 || param2 == 1008579 ) // ACTOR1 = MINFILIA
        {
          Scene00002( player ); // Scene00002: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=MINFILIA
          break;
        }
        if( param1 == 1009089 || param2 == 1009089 ) // ACTOR2 = MESSENGER01447
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse306:66983 calling Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove, ENpcBind), id=ALPHINAUD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
