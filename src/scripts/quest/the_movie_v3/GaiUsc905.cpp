...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006642 || param2 == 1006642 ) // ACTOR1 = ENPC
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            ...
            // +Callback Scene00004: Normal(Talk, TargetCanMove), id=ENPC
          }
          break;
        }
        if( param1 == 1007584 || param2 == 1007584 ) // ACTOR2 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002363 || param2 == 2002363 ) // EOBJECT0 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1007604 || param2 == 1007604 ) // ACTOR0 = SPIRALINGPATH
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc905:66576 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=SPIRALINGPATH" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc905:66576 calling Scene00003: Normal(Talk, TargetCanMove), id=ENPC" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00004( player );
    };
  ...
  {
    player.sendDebug( "GaiUsc905:66576 calling Scene00004: Normal(Talk, TargetCanMove), id=ENPC" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc905:66576 calling Scene00007: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
  ...
  void Scene00011( Entity::Player& player ) //SEQ_255: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsc905:66576 calling Scene00011: Normal(None), id=unknown" );
  }
