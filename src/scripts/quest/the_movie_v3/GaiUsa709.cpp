...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 255:
      {
        if( type != 2 ) Scene00022( player ); // Scene00022: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=GUNDOBALD
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00006( Entity::Player& player ) //SEQ_1: EOBJECT0, UI8CH = 1, Flag8(4)=True
  {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_1: EOBJECT1, UI8CL = 1, Flag8(5)=True
  {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_1: ACTOR4, <No Var>, <No Flag>
  {
  ...
  void Scene00011( Entity::Player& player ) //SEQ_2: ACTOR0, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00013( Entity::Player& player ) //SEQ_3: ACTOR5, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00014( Entity::Player& player ) //SEQ_3: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa709:66318 calling Scene00014: Normal(None), id=unknown" );
    checkProgressSeq3( player );
  }

  void Scene00015( Entity::Player& player ) //SEQ_3: ACTOR6, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa709:66318 calling Scene00015: Normal(None), id=unknown" );
  }

  void Scene00016( Entity::Player& player ) //SEQ_3: ACTOR7, <No Var>, <No Flag>
  {
  ...
  void Scene00018( Entity::Player& player ) //SEQ_3: ACTOR8, <No Var>, <No Flag>
  {
  ...
  void Scene00019( Entity::Player& player ) //SEQ_3: ACTOR9, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa709:66318 calling Scene00019: Normal(None), id=unknown" );
  }

  void Scene00020( Entity::Player& player ) //SEQ_3: ACTOR10, <No Var>, <No Flag>
  {
  ...
  void Scene00022( Entity::Player& player ) //SEQ_255: , <No Var>, <No Flag>
  {
