...
const uint32_t FFXIV_THE_MOVIE_INSTANCE_QUEST_ID = 67881;
const uint8_t FFXIV_THE_MOVIE_INSTANCE_QUEST_SEQ_REQUIRED = 8;
const uint8_t FFXIV_THE_MOVIE_INSTANCE_QUEST_SEQ_TARGET = 255;
const uint32_t SCENE_LIST[] = { 368, 0 };
//===========THE_MOVIE end============
...
public:
  TheNavelHard() :
    Sapphire::ScriptAPI::InstanceContentScript( 20005 )
  { }
