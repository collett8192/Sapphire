...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( param1 == 1012759 || param2 == 1012759 ) // ACTOR0 = MOGHAN
        {
        ...
        if( param1 == 1012756 || param2 == 1012756 ) // ACTOR1 = ALPHINAUD
        {
          Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1012757 || param2 == 1012757 ) // ACTOR2 = ESTINIEN
        {
          Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=ESTINIEN
          break;
        }
        if( param1 == 1012758 || param2 == 1012758 ) // ACTOR3 = ICEHEART
        {
      ...
      case 1:
      {
        if( param1 == 2005459 || param2 == 2005459 ) // EOBJECT0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 255:
      {
        ...
        if( param1 == 1012696 || param2 == 1012696 ) // ACTOR8 = ICEHEART
        {
...
private:
  ...
  {
    player.sendDebug( "HeaVna326:67163 calling Scene00001: Normal(Talk, NpcDespawn, QuestAccept, TargetCanMove), id=MOGHAN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00005( Entity::Player& player ) //SEQ_1: EOBJECT0, UI8AL = 1, Flag8(1)=True
  {
  ...
  {
    player.sendDebug( "HeaVna326:67163 calling Scene00012: Normal(Talk, TargetCanMove), id=ICEHEART" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
    };
