...
// Quest Script: GaiUsb104_00823
// Quest Name: Fetch the Freshman
// Quest ID: 66359
// Start NPC: 1006287
// End NPC: 1006287
...
//    static constexpr auto Actor0 = 1006287;
//    static constexpr auto Actor1 = 1006289;
//    static constexpr auto Enemy0 = 4293202;
//    static constexpr auto Enemy1 = 4293203;
//    static constexpr auto Eobject0 = 2002290;
//    static constexpr auto Eventrange0 = 4293204;
...
if( actor == 1006289 ) { Scene00002( player ); }
//if( actorId == 4293202 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//if( actorId == 4293203 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//EOBJECT0, null, 0, -2, False
if( actor == 2002290 ) { Scene00003( player ); }
break;
}
case 255:{
Scene00007( player );
