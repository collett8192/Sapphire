...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001996 || param2 == 2001996 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2001997 || param2 == 2001997 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2001998 || param2 == 2001998 ) // EOBJECT2 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1006258 || param2 == 1006258 ) // ACTOR0 = ADEMAR
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa903:66334 calling Scene00010: Normal(None), id=unknown" );
  }

  void Scene00012( Entity::Player& player ) //SEQ_255: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa903:66334 calling Scene00012: Normal(None), id=unknown" );
  }

  void Scene00014( Entity::Player& player ) //SEQ_255: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa903:66334 calling Scene00014: Normal(None), id=unknown" );
  }
};
