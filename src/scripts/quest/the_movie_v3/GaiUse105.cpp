...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( actor == 1006357 || actorId == 1006357 ) // ACTOR2 = MEMEDESU
        {
        ...
        if( actor == 1007723 || actorId == 1007723 ) // ACTOR1 = FLHAMINN
        {
      ...
      case 3:
      {
        if( actor == 1006294 || actorId == 1006294 ) // ACTOR3 = ODINEL
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
...
private:
  ...
  {
    player.sendDebug( "GaiUse105:66715 calling [BranchTrue]Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse105:66715 calling [BranchTrue]Scene00004: Normal(Talk, TargetCanMove), id=MEMEDESU" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse105:66715 calling [BranchTrue]Scene00010: Normal(Talk, TargetCanMove), id=MEMEDESU" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
  ...
  {
    player.sendDebug( "GaiUse105:66715 calling [BranchTrue]Scene00013: Normal(Talk, FadeIn, TargetCanMove), id=FLHAMINN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse105:66715 calling Scene00014: Normal(CutScene), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00015( player );
    };
  ...
  {
    player.sendDebug( "GaiUse105:66715 calling [BranchTrue]Scene00015: Normal(FadeIn, QuestReward, QuestComplete), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
