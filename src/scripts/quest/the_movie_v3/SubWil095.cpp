...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001368 || param2 == 2001368 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 3952090 || param2 == 3952090 ) // ENEMY0 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(None), id=unknown
          break;
        }
        if( param1 == 2001369 || param2 == 2001369 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 3952281 || param2 == 3952281 ) // ENEMY1 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 2001735 || param2 == 2001735 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 3952286 || param2 == 3952286 ) // ENEMY2 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "SubWil095:66039 calling Scene00002: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "SubWil095:66039 calling Scene00005: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_1: EOBJECT2, UI8BL = 1, Flag8(3)=True
  {
    player.sendDebug( "SubWil095:66039 calling Scene00008: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00009( Entity::Player& player ) //SEQ_1: ENEMY2, <No Var>, <No Flag>
  {
  ...
  {
    player.sendDebug( "SubWil095:66039 calling Scene00011: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
