...
if( actor == 1002935 ) { Scene00013( player ); }
break;
}
case 255:{
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](7)Empty:Scene00008 ", getId() );
...
player.sendDebug( "questId: {}, calling Talk, Inventory:Scene00010 +2 ", getId() );
