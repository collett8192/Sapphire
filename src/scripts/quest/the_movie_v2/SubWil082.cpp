...
// Quest Script: SubWil082_00330
// Quest Name: Last Letter to Lost Hope
// Quest ID: 65866
// Start NPC: 1002058
// End NPC: 1001605
...
//    static constexpr auto Actor1 = 1001604;
//    static constexpr auto Actor2 = 1001606;
//    static constexpr auto Actor3 = 1001605;
//    static constexpr auto Item0 = 2000377;
...
if( actor == 1001604 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00001( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1001606 ) { Scene00002( player ); }
break;
}
case 255:{
//ACTOR3, null, 0, -1, False
if( actor == 1001605 ) { Scene00003( player ); }
//ACTOR1, null, 0, -1, False
if( actor == 1001604 ) { Scene00006( player ); }
//ACTOR2, null, 0, -1, False
if( actor == 1001606 ) { Scene00007( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling [sub:Execute](3)Talk, QuestReward, QuestComplete:Scene00004 ACTOR3", getId() );
