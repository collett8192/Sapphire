...
// Quest Script: GaiUsa310_00742
// Quest Name: Shadows of the Empire
// Quest ID: 66278
// Start NPC: 1000598
// End NPC: 1000598
...
//    static constexpr auto Enemy0 = 4278617;
//    static constexpr auto Enemy1 = 4279022;
//    static constexpr auto Eobject0 = 2001955;
//    static constexpr auto Eobject1 = 2001956;
...
if( actor == 2001955 ) { Scene00003( player ); }
//if( actorId == 4278617 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
//EOBJECT1, null, 0, -2, False
if( actor == 2001956 ) { Scene00005( player ); }
//if( actorId == 4279022 && player.getQuestUI8BH( getId() ) != 1 ) { Scene?????( player ); }
break;
}
case 255:{
Scene00006( player );
