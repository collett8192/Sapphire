...
class BanIxa001 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto MotEventJoy = 953;
  ...
  public:
    BanIxa001() : Sapphire::ScriptAPI::EventScript( 67022 ){}; 
    ~BanIxa001() = default; 
