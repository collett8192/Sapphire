...
if( actor == 1006590 && player.getQuestUI8AL( getId() ) != 4 ) { Scene00002( player ); }
//ACTOR2, UI8AL, 4, -2, False
if( actor == 1006591 && player.getQuestUI8AL( getId() ) != 4 ) { Scene00003( player ); }
//ACTOR3, UI8AL, 4, -2, False
if( actor == 1006592 && player.getQuestUI8AL( getId() ) != 4 ) { Scene00004( player ); }
//ACTOR4, UI8AL, 4, -2, False
if( actor == 1006593 && player.getQuestUI8AL( getId() ) != 4 ) { Scene00005( player ); }
break;
}
case 255:{
Scene00006( player );
