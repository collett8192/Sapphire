...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002003 || param2 == 2002003 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002004 || param2 == 2002004 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002005 || param2 == 2002005 ) // EOBJECT2 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa911:66342 calling Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsa911:66342 calling Scene00005: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsa911:66342 calling Scene00007: Normal(None), id=unknown" );
