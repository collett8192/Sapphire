...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002208 || param2 == 2002208 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002584 || param2 == 2002584 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002605 || param2 == 2002605 ) // EOBJECT2 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc501:66525 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=GUOLGEIM" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc501:66525 calling Scene00003: Normal(Message, QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc501:66525 calling Scene00005: Normal(Message, QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc501:66525 calling Scene00007: Normal(Message, QuestGimmickReaction), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc501:66525 calling Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=GUOLGEIM" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
