...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=LAURENCE
        break;
      }
      //seq 2 event item ITEM0 = UI8BH max stack 1
      case 2:
      {
        if( param1 == 2002165 || param2 == 2002165 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 1006477 || param2 == 1006477 ) // ACTOR1 = LAURENCE
        {
      ...
      case 255:
      {
        if( param1 == 1006698 || param2 == 1006698 ) // ACTOR0 = CHARMINE
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb912:66471 calling Scene00004: Normal(None), id=unknown" );
