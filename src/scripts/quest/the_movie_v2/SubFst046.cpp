...
if( actor == 1000792 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00001( player ); }
//ACTOR2, UI8AL, 3, -2, False
if( actor == 1000793 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00002( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1000794 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00003( player ); }
break;
}
case 255:{
Scene00004( player );
