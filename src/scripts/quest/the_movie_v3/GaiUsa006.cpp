...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2000720 || param2 == 2000720 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2000721 || param2 == 2000721 ) // EOBJECT1 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
        ...
        if( param1 == 2000722 || param2 == 2000722 ) // EOBJECT2 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
      ...
      case 255:
      {
        if( param1 == 1000615 || param2 == 1000615 ) // ACTOR0 = YSABEL
        {
...
private:
  ...
  void Scene00006( Entity::Player& player ) //SEQ_1: EOBJECT2, UI8AL = 3, Flag8(3)=True
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_255: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa006:66248 calling Scene00010: Normal(None), id=unknown" );
  }

  void Scene00012( Entity::Player& player ) //SEQ_255: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa006:66248 calling Scene00012: Normal(None), id=unknown" );
  }

  void Scene00014( Entity::Player& player ) //SEQ_255: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa006:66248 calling Scene00014: Normal(None), id=unknown" );
  }
};
