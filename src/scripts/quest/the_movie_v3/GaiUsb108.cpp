...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002048 || param2 == 2002048 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002047 || param2 == 2002047 ) // EOBJECT1 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(None), id=unknown
          break;
        }
        if( param1 == 4334161 || param2 == 4334161 ) // ENEMY0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002049 || param2 == 2002049 ) // EOBJECT2 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(Message, PopBNpc), id=unknown
          break;
        }
        if( param1 == 4334162 || param2 == 4334162 ) // ENEMY1 = unknown
        {
      ...
      case 2:
      {
        if( type != 2 ) Scene00007( player ); // Scene00007: Normal(Message, PopBNpc), id=unknown
        break;
      }
      case 3:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=MUMUGOI
        break;
      }
      case 255:
      {
        if( type != 2 ) Scene00009( player ); // Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=MUMUGOI
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb108:66363 calling Scene00003: Normal(None), id=unknown" );
  ...
  void Scene00005( Entity::Player& player ) //SEQ_1: EOBJECT2, <No Var>, Flag8(3)=True
  {
