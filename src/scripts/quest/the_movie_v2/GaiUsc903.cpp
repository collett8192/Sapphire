...
//    static constexpr auto Eobject0 = 2002255;
//    static constexpr auto Eobject1 = 2002253;
//    static constexpr auto Eobject2 = 2002254;
...
if( actor == 2002255 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2002253 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//EOBJECT2, null, 0, -2, False
if( actor == 2002254 ) { Scene00006( player ); }
//ENEMY0, UI8BL, 1, -2, False
if( actorId == 4301884 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00007( player ); }
break;
}
case 255:{
Scene00008( player );
...
player.sendDebug( "questId: {}, calling Message:Scene00007 ENEMY0:UI8BL=-2, 1", getId() );
