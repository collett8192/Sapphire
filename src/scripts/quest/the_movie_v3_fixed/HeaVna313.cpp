...
//fix: skip mob kill, workaround for duplicated dialog
...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( actor == 1012636 || actorId == 1012636 ) // ACTOR0 = ICEHEART
        {
          Scene00000( player ); // Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown
          // +Callback Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=ICEHEART
        }
        if( actor == 1012637 || actorId == 1012637 ) // ACTOR1 = ESTINIEN
        {
          Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=ESTINIEN
        }
        if( actor == 1012632 || actorId == 1012632 ) // ACTOR2 = ALPHINAUD
        {
      ...
      case 1:
      {
        if( actor == 1011928 || actorId == 1011928 ) // ACTOR3 = STORYTELLER
        {
        ...
        if( actor == 1011929 || actorId == 1011929 ) // ACTOR4 = IDATEN
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
        ...
        if( actor == 1011930 || actorId == 1011930 ) // ACTOR5 = CIBLEROIT
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
        ...
        if( actor == 1014195 || actorId == 1014195 ) // ACTOR6 = ALPHINAUD
        {
          Scene00010( player ); // Scene00010: Normal(Talk, TargetCanMove), id=ALPHINAUD
        }
        if( actor == 1014196 || actorId == 1014196 ) // ACTOR7 = ESTINIEN
        {
          Scene00011( player ); // Scene00011: Normal(Talk, TargetCanMove), id=ESTINIEN
        }
        if( actor == 1014197 || actorId == 1014197 ) // ACTOR8 = ICEHEART
        {
      ...
      case 2:
      {
        if( actor == 1011931 || actorId == 1011931 ) // ACTOR9 = NANKAEATER
        {
      ...
      case 4:
      {
        ...
        if( actor == 1013582 || actorId == 1013582 ) // ACTOR10 = ALPHINAUD
        {
          Scene00029( player ); // Scene00029: Normal(Talk, TargetCanMove), id=ALPHINAUD
        }
        if( actor == 1013583 || actorId == 1013583 ) // ACTOR11 = ESTINIEN
        {
          Scene00030( player ); // Scene00030: Normal(Talk, TargetCanMove), id=ESTINIEN
        }
        if( actor == 1012672 || actorId == 1012672 ) // ACTOR12 = ICEHEART
        {
...
private:
  ...
  {
    player.sendDebug( "HeaVna313:67150 calling [BranchTrue]Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=ICEHEART" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "HeaVna313:67150 calling [BranchTrue]Scene00005: Normal(Talk, TargetCanMove), id=STORYTELLER" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "HeaVna313:67150 calling [BranchTrue]Scene00007: Normal(Talk, TargetCanMove), id=IDATEN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
      checkProgressSeq1( player );
  ...
  {
    player.sendDebug( "HeaVna313:67150 calling [BranchTrue]Scene00009: Normal(Talk, TargetCanMove), id=CIBLEROIT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
      checkProgressSeq1( player );
  ...
  {
    player.sendDebug( "HeaVna313:67150 calling [BranchTrue]Scene00028: Normal(Talk, TargetCanMove), id=NANKAEATER" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
  ...
  {
    player.sendDebug( "HeaVna313:67150 calling Scene00035: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
