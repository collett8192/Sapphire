...
//    static constexpr auto Actor1 = 1006228;
...
if( actor == 1006228 ) { Scene00002( player ); }
//if( actorId == 4279871 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//if( actorId == 4279874 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
break;
}
case 2:{
Scene00003( player );
