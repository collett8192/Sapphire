...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove, SystemTalk), id=BOTULF
        break;
      }
      case 2:
      {
      ...
      case 3:
      {
        if( type != 2 ) Scene00004( player ); // Scene00004: Normal(Talk, TargetCanMove, SystemTalk), id=BOTULF
        break;
      }
      case 4:
      {
      ...
      case 5:
      {
        if( type != 2 ) Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=BOTULF
      ...
      case 255:
      {
        if( type != 2 ) Scene00009( player ); // Scene00009: Normal(Talk, TargetCanMove, SystemTalk), id=BOTULF
