...
//    static constexpr auto Actor0 = 1002027;
//    static constexpr auto Eobject0 = 2001273;
//    static constexpr auto Eobject1 = 2001274;
//    static constexpr auto Eobject2 = 2001275;
...
if( actor == 2001273 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00001( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2001274 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//EOBJECT2, UI8BL, 1, -2, False
if( actor == 2001275 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00007( player ); }
break;
}
case 255:{
Scene00010( player );
