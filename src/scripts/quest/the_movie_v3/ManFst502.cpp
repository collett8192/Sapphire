...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006662 || param2 == 1006662 ) // ACTOR2 = unknown
        {
          Scene00002( player ); // Scene00002: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006663 || param2 == 1006663 ) // ACTOR3 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006664 || param2 == 1006664 ) // ACTOR4 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006660 || param2 == 1006660 ) // ACTOR5 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006661 || param2 == 1006661 ) // ACTOR6 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007682 || param2 == 1007682 ) // ACTOR7 = MINFILIA
        {
          Scene00007( player ); // Scene00007: Normal(Talk, TargetCanMove), id=MINFILIA
          break;
        }
        if( param1 == 1007683 || param2 == 1007683 ) // ACTOR8 = ALPHINAUD
        {
          Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1006657 || param2 == 1006657 ) // ACTOR0 = RAUBAHN
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00010( player ); // Scene00010: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=RAUBAHN
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "ManFst502:66672 calling Scene00001: Normal(CutScene, Message, QuestAccept), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
