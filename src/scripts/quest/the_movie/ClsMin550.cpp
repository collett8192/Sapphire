...
class ClsMin550 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto Ritem0 = 12537;
  ...
  public:
    ClsMin550() : Sapphire::ScriptAPI::EventScript( 67618 ){}; 
    ~ClsMin550() = default; 
