...
class GaiUsb410 : public Sapphire::ScriptAPI::EventScript
{
public:
  GaiUsb410() : Sapphire::ScriptAPI::EventScript( 66402 ){}; 
  ~GaiUsb410() = default; 
...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        Scene00004( player ); // Scene00004: Normal(Talk, Inventory, TargetCanMove), id=GODBERT
        break;
      }
      //seq 3 event item ITEM0 = UI8BH max stack 4
      case 3:
      {
        Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=GODBERT
        break;
      }
      //seq 4 event item ITEM0 = UI8BH max stack 4
      case 4:
      {
        Scene00006( player ); // Scene00006: Normal(Talk, Inventory, TargetCanMove), id=GODBERT
        break;
      }
      case 5:
      {
        Scene00007( player ); // Scene00007: Normal(Talk, TargetCanMove), id=GODBERT
        break;
      }
      case 6:
      {
        Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=GODBERT
        break;
      }
      case 255:
      {
        Scene00009( player ); // Scene00009: Normal(Talk, TargetCanMove), id=GODBERT
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb410:66402 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=RUKUSAFARUSA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb410:66402 calling [BranchTrue]Scene00003: Normal(Talk, TargetCanMove), id=GODBERT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
