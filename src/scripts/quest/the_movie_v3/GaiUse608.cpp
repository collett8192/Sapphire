...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 2005060 || actorId == 2005060 ) // EOBJECT0 = unknown
        {
      ...
      case 255:
      {
        if( actor == 1008969 || actorId == 1008969 ) // ACTOR1 = MINFILIA
        {
          Scene00007( player ); // Scene00007: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=MINFILIA
        }
        if( actor == 1010999 || actorId == 1010999 ) // ACTOR4 = TATARU
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse608:65956 calling [BranchTrue]Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse608:65956 calling Scene00002: Normal(None), id=unknown" );
    Scene00003( player );
  }
  void Scene00003( Entity::Player& player )
  {
    player.sendDebug( "GaiUse608:65956 calling [BranchTrue]Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUse608:65956 calling Scene00007: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
