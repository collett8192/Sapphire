...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002090 || param2 == 2002090 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4294757 || param2 == 4294757 ) // ENEMY0 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(Message, PopBNpc), id=unknown
          break;
        }
        if( param1 == 2002091 || param2 == 2002091 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4294759 || param2 == 4294759 ) // ENEMY1 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(Message, PopBNpc), id=unknown
          break;
        }
        if( param1 == 2002092 || param2 == 2002092 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 4294760 || param2 == 4294760 ) // ENEMY2 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=BLOEIDINL
        break;
      }
      default:
      {
