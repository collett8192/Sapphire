...
const uint16_t STATUS_ID_INTERVENTION = 1174;
const uint16_t STATUS_ID_INTERVENTION_NEEMA = 169;

class ActionIntervention7382 :
  public ScriptAPI::ActionScript
{
public:
  ActionIntervention7382() :
    ScriptAPI::ActionScript( 7382 )
  {
  }
  ...
  void onExecute( Sapphire::World::Action::Action& action ) override
  {
    ...
    auto pNewEffect = Sapphire::StatusEffect::make_StatusEffect( STATUS_ID_INTERVENTION, action.getSourceChara(), pTarget, 7000, 3000 );
...
EXPOSE_SCRIPT( ActionIntervention7382 );