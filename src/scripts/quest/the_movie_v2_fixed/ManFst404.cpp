...
if( actor == 1007690 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR0, null, 0, -2, False
if( actor == 1006492 ) { Scene00004( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1000106 ) { Scene00002( player ); }
break;
}
case 2:{
//ACTOR2, null, 0, -2, False
if( actor == 1007690 ) { Scene00006( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling Talk, Message:Scene00003 ACTOR0", getId() );
