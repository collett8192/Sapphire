...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( type != 2 ) Scene00000( player ); // Scene00000: Normal(Talk, YesNo, QuestOffer, QuestAccept, TargetCanMove), id=FLAMEOFFICER
        break;
      }
      case 1:
      {
        if( param1 == 1002391 || param2 == 1002391 ) // ACTOR1 = FLAMEPERSONNEL
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00001( player ); // Scene00001: Normal(Talk, FadeIn, TargetCanMove, Menu), id=FLAMEPERSONNEL
          }
          break;
        }
        if( param1 == 1004884 || param2 == 1004884 ) // ACTOR2 = SERPENTOFFICER
        {
        ...
        if( param1 == 1004883 || param2 == 1004883 ) // ACTOR0 = FLAMEOFFICER
        {
      ...
      case 2:
      {
        if( param1 == 1004887 || param2 == 1004887 ) // ACTOR4 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
        ...
        if( param1 == 1004995 || param2 == 1004995 ) // ACTOR5 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 1004996 || param2 == 1004996 ) // ACTOR6 = unknown
        {
          Scene00007( player ); // Scene00007: Normal(None), id=unknown
          break;
        }
        if( param1 == 1004997 || param2 == 1004997 ) // ACTOR7 = unknown
        {
        ...
        if( param1 == 4126799 || param2 == 4126799 ) // EVENTRANGE0 = unknown
        {
          Scene00013( player ); // Scene00013: Normal(QuestBattle, YesNo), id=unknown
          break;
        }
        if( param1 == 2001714 || param2 == 2001714 ) // EOBJECT0 = unknown
        {
          Scene00015( player ); // Scene00015: Normal(None), id=unknown
          break;
        }
        if( param1 == 2001808 || param2 == 2001808 ) // EOBJECT1 = unknown
        {
...
private:
  ...
  void checkProgressSeq2( Entity::Player& player )
  {
    if( player.getQuestUI8AL( getId() ) == 1 )
    {
      ...
      player.setQuestBitFlag16( getId(), 9, false );
  ...
  void Scene00005( Entity::Player& player ) //SEQ_2: ACTOR4, UI8AL = 1, Flag16(1)=True
  {
    ...
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
        ...
        pTeriMgr.createAndJoinQuestBattle( player, 47 );
      }
    };
  ...
  void Scene00013( Entity::Player& player ) //SEQ_2: EVENTRANGE0, <No Var>, Flag16(9)=True
  {
  ...
  void Scene00015( Entity::Player& player ) //SEQ_2: EOBJECT0, <No Var>, <No Flag>
  {
    player.sendDebug( "ManWil302:66218 calling Scene00015: Normal(None), id=unknown" );
    checkProgressSeq2( player );
  }

  void Scene00017( Entity::Player& player ) //SEQ_2: EOBJECT1, <No Var>, <No Flag>
  {
    player.sendDebug( "ManWil302:66218 calling Scene00017: Normal(None), id=unknown" );
    checkProgressSeq2( player );
  }

  void Scene00018( Entity::Player& player ) //SEQ_255: ACTOR1, <No Var>, <No Flag>
  {
  ...
  void Scene00021( Entity::Player& player ) //SEQ_255: ACTOR3, <No Var>, <No Flag>
  {
