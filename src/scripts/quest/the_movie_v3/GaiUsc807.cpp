...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 1006626 || actorId == 1006626 ) // ACTOR1 = NORTMOEN
        {
        ...
        if( actor == 1006627 || actorId == 1006627 ) // ACTOR2 = STHALRHET
        {
      ...
      case 255:
      {
        Scene00006( player ); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=EILIS
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc807:66567 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=EILIS" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc807:66567 calling [BranchTrue]Scene00003: Normal(Talk, TargetCanMove), id=NORTMOEN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc807:66567 calling [BranchTrue]Scene00005: Normal(Talk, TargetCanMove), id=STHALRHET" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
