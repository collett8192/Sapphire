...
//[switches]A: False, A2: False, A3: True, S: True, R: False, DM: True, L: False, DBM: False
//parsingResult: 0
...
if( actor == 2002193 ) { Scene00002( player ); }
//if( actorId == 4300660 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
break;
}
case 2:{
//EOBJECT1, UI8AL, 1, -2, False
if( actor == 2002194 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00004( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1006686 ) { Scene00005( player ); }
break;
}
case 3:{
Scene00007( player );
...
if( actor == 2002195 ) { Scene00008( player ); }
//ENEMY1, UI8AL, 1, -2, False
if( actorId == 4300668 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00009( player ); }
break;
}
case 255:{
Scene00010( player );
...
player.sendDebug( "questId: {}, calling Inventory:Scene00004 EOBJECT1:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](5)Talk:Scene00006 ACTOR1", getId() );
...
player.sendDebug( "questId: {}, calling Inventory:Scene00008 EOBJECT2", getId() );
...
player.sendDebug( "questId: {}, calling Message:Scene00009 ENEMY1:UI8AL=-2, 1", getId() );
