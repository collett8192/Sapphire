...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( actor == 2002062 || actorId == 2002062 ) // EOBJECT0 = unknown
        {
        ...
        if( actor == 4293297 || actorId == 4293297 ) // ENEMY0 = unknown
        {
          // empty entry
        }
        break;
...
private:
  ...
  {
    player.sendDebug( "GaiUsb309:66386 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=SHAMANILOHMANI" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb309:66386 calling [BranchTrue]Scene00003: Normal(Talk, TargetCanMove), id=DREST" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb309:66386 calling [BranchTrue]Scene00005: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb309:66386 calling [BranchTrue]Scene00007: Normal(Talk, FadeIn, TargetCanMove), id=SHAMANILOHMANI" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsb309:66386 calling [BranchTrue]Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=WHEISKAET" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
