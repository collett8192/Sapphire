...
// Quest Script: GaiUsb510_00879
// Quest Name: Mr. Slipshod and Ms. Uptight
// Quest ID: 66415
// Start NPC: 1006363
// End NPC: 1006363
...
//    static constexpr auto Actor0 = 1006363;
//    static constexpr auto Actor1 = 1006364;
//    static constexpr auto Enemy0 = 4296835;
//    static constexpr auto Enemy1 = 4296837;
//    static constexpr auto Eobject0 = 2002321;
//    static constexpr auto Eventrange0 = 4296808;
...
if( actor == 1006364 ) { Scene00002( player ); }
//if( actorId == 4296835 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//if( actorId == 4296837 && player.getQuestUI8AL( getId() ) != 2 ) { Scene?????( player ); }
//EOBJECT0, null, 0, -2, False
if( actor == 2002321 ) { Scene00003( player ); }
break;
}
case 255:{
Scene00007( player );
