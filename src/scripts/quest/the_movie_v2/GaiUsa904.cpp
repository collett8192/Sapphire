...
//[switches]A: False, A2: False, A3: False, S: True, R: False, DM: True
...
if( actorId == 4299601 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//EOBJECT0, null, 0, -2, False
if( actor == 2002462 ) { Scene00004( player ); }
break;
}
case 255:{
Scene00007( player );
