...
if( actor == 2002187 ) { Scene00003( player ); }
//if( actorId == 4300168 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
//EOBJECT1, null, 0, -2, False
if( actor == 2002631 ) { Scene00005( player ); }
break;
}
case 255:{
//ACTOR0, null, 0, -1, False
if( actor == 1006505 ) { Scene00006( player ); }
//EOBJECT1, null, 0, -1, False
if( actor == 2002631 ) { Scene00009( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling Empty:Scene00005 EOBJECT1", getId() );
