...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( type != 2 ) Scene00004( player ); // Scene00004: Normal(Talk, Inventory, TargetCanMove), id=GODBERT
        break;
      }
      //seq 3 event item ITEM0 = UI8BH max stack 4
      case 3:
      {
        if( type != 2 ) Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=GODBERT
        break;
      }
      //seq 4 event item ITEM0 = UI8BH max stack 4
      case 4:
      {
        if( type != 2 ) Scene00006( player ); // Scene00006: Normal(Talk, Inventory, TargetCanMove), id=GODBERT
        break;
      }
      case 5:
      {
        if( type != 2 ) Scene00007( player ); // Scene00007: Normal(Talk, TargetCanMove), id=GODBERT
        // +Callback Scene00008: Normal(Talk, TargetCanMove), id=GODBERT
        break;
      }
      case 6:
      {
        if( type != 2 ) Scene00009( player ); // Scene00009: Normal(Talk, TargetCanMove), id=GODBERT
      ...
      case 255:
      {
        if( type != 2 ) Scene00012( player ); // Scene00012: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=RUKUSAFARUSA
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00009( Entity::Player& player ) //SEQ_6: , <No Var>, <No Flag>
  {
