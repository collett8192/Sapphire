...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2097153 || param2 == 5010000 ) // ACTOR1 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00003( player ); // Scene00003: Normal(FadeIn, SystemTalk), id=unknown
          }
          break;
        }
        if( param1 == 1007651 || param2 == 1007651 ) // ACTOR2 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007652 || param2 == 1007652 ) // ACTOR3 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007653 || param2 == 1007653 ) // ACTOR4 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1000168 || param2 == 1000168 ) // ACTOR5 = VORSAILE
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa402:66280 calling Scene00004: Normal(None), id=unknown" );
  }

  void Scene00005( Entity::Player& player ) //SEQ_1: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa402:66280 calling Scene00005: Normal(None), id=unknown" );
  }

  void Scene00006( Entity::Player& player ) //SEQ_1: ACTOR4, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa402:66280 calling Scene00006: Normal(None), id=unknown" );
  }
  ...
  {
    player.sendDebug( "GaiUsa402:66280 calling Scene00009: Normal(None), id=unknown" );
  }

  void Scene00010( Entity::Player& player ) //SEQ_255: ACTOR3, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa402:66280 calling Scene00010: Normal(None), id=unknown" );
  }

  void Scene00011( Entity::Player& player ) //SEQ_255: ACTOR4, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsa402:66280 calling Scene00011: Normal(None), id=unknown" );
  }
};
