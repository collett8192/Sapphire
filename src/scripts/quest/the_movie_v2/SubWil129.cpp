...
if( actor == 1004325 && player.getQuestUI8AL( getId() ) != 5 ) { Scene00003( player ); }
//ACTOR3, UI8AL, 5, -2, False
if( actor == 1004327 && player.getQuestUI8AL( getId() ) != 5 ) { Scene00004( player ); }
//ACTOR4, UI8AL, 5, -2, False
if( actor == 1004506 && player.getQuestUI8AL( getId() ) != 5 ) { Scene00005( player ); }
//ACTOR5, UI8AL, 5, -2, False
if( actor == 1004556 && player.getQuestUI8AL( getId() ) != 5 ) { Scene00006( player ); }
//ACTOR6, null, 0, -2, False
if( actor == 1004324 ) { Scene00007( player ); }
//ACTOR0, null, 0, -2, True
if( actor == 1003929 ) { Scene00008( player ); }
break;
}
case 2:{
Scene00009( player );
...
if( actor == 1004330 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00010( player ); }
//ACTOR0, null, 0, -2, True
if( actor == 1003929 ) { Scene00013( player ); }
break;
}
case 255:{
Scene00024( player );
...
player.sendDebug( "questId: {}, calling Talk:Scene00002 ACTOR1:UI8AL=-2, 5", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](10)Talk:Scene00011 ACTOR7:UI8AL=-2, 1", getId() );
