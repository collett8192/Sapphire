...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( param1 == 2002639 || param2 == 2002639 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4292674 || param2 == 4292674 ) // ENEMY0 = unknown
        {
          Scene00006( player ); // Scene00006: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002638 || param2 == 2002638 ) // EOBJECT2 = unknown
        {
...
private:
  ...
  void Scene00007( Entity::Player& player ) //SEQ_2: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsb005:66348 calling Scene00007: Normal(None), id=unknown" );
    checkProgressSeq2( player );
  }
  ...
  void Scene00011( Entity::Player& player ) //SEQ_255: EOBJECT2, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsb005:66348 calling Scene00011: Normal(None), id=unknown" );
  }
};
