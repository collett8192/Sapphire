...
private:
  ...
  void Scene00008( Entity::Player& player ) //SEQ_1: EOBJECT2, <No Var>, <No Flag>
  {
  ...
  void Scene00020( Entity::Player& player ) //SEQ_255: EOBJECT3, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsb003:66346 calling Scene00020: Normal(None), id=unknown" );
  }

  void Scene00022( Entity::Player& player ) //SEQ_255: EOBJECT4, <No Var>, <No Flag>
  {
    player.sendDebug( "GaiUsb003:66346 calling Scene00022: Normal(None), id=unknown" );
  }

  void Scene00024( Entity::Player& player ) //SEQ_255: EOBJECT5, <No Var>, <No Flag>
  {
