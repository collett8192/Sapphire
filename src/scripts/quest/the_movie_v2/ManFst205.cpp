...
//    static constexpr auto Actor1 = 1004621;
//    static constexpr auto Actor2 = 1002285;
//    static constexpr auto Actor3 = 1004623;
//    static constexpr auto Actor4 = 1004624;
...
if( actor == 1002285 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1004623 ) { Scene00004( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1004624 ) { Scene00005( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1004621 ) { Scene00006( player ); }
break;
}
case 3:{
//ACTOR3, null, 0, -2, False
if( actor == 1004623 ) { Scene00007( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1004624 ) { Scene00008( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1002285 ) { Scene00009( player ); }
break;
}
case 4:{
...
if( actor == 1004621 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00010( player ); }
//EOBJECT0, null, 0, -2, False
if( actor == 2001854 ) { Scene00011( player ); }
break;
}
case 5:{
...
player.sendDebug( "questId: {}, calling QuestBattle, YesNo:Scene00010 ACTOR1:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:CombinedCutScene](11)CutScene:Scene00012 EOBJECT0", getId() );
...
player.sendDebug( "questId: {}, calling Talk, QuestReward, QuestComplete, FadeOut:Scene00013 ", getId() );
