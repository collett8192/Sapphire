  ...
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        ...
        if( param1 == 1006646 || param2 == 1006646 ) // ACTOR0 = unknown
        {
          Scene00004( player );
          break;
        }
      ...
      case 2:
      {
        if( param1 == 1006662 || param2 == 1006662 ) // ACTOR3 = EDELSTEIN
        {
          break;
        }
      ...
      case 255:
      {
        Scene00013( player ); // Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=RAUBAHN
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "XxaFst502:69409 calling Scene00003: Normal(CutScene, FadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
