...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( param1 == 1008696 || param2 == 1008696 ) // ACTOR0 = YUGIRI
        {
      ...
      case 255:
      {
        if( param1 == 1008579 || param2 == 1008579 ) // ACTOR3 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse219:66899 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=YUGIRI" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse219:66899 calling Scene00004: Normal(CutScene, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      Scene00005( player );
    };
  ...
  {
    player.sendDebug( "GaiUse219:66899 calling Scene00005: Normal(FadeIn, QuestReward, QuestComplete), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
