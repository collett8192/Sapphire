...
//    static constexpr auto Actor0 = 1000671;
//    static constexpr auto Eobject0 = 2000145;
...
player.sendDebug( "questId: {}, calling [sub:Execute](2)QuestReward, QuestComplete:Scene00098 ", getId() );
