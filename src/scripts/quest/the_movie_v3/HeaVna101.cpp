...
// param used:
//WARP_TEMPLEKNIGHT01580 = 418|0|-2.6|141.3|-3.14|true
//PRIVATE_SCENE16 = 433
...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1012308 || param2 == 1012308 ) // ACTOR1 = HAURCHEFANT
        {
        ...
        if( param1 == 1010925 || param2 == 1010925 ) // ACTOR0 = ALPHINAUD
        {
          Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1010926 || param2 == 1010926 ) // ACTOR2 = TATARU
        {
      ...
      case 2:
      {
        if( param1 == 1012309 || param2 == 1012309 ) // ACTOR3 = TEMPLEKNIGHT01580
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00005( player ); // Scene00005: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=TEMPLEKNIGHT01580
          }
          break;
        }
        if( param1 == 1010925 || param2 == 1010925 ) // ACTOR0 = ALPHINAUD
      ...
      case 4:
      {
        if( param1 == 1012310 || param2 == 1012310 ) // ACTOR4 = BUTLER01580
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00012( player ); // Scene00012: Normal(Talk, NpcDespawn, TargetCanMove, ENpcBind), id=BUTLER01580
          }
          break;
        }
        if( param1 == 1012311 || param2 == 1012311 ) // ACTOR5 = ALPHINAUD
        {
          Scene00013( player ); // Scene00013: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1012312 || param2 == 1012312 ) // ACTOR6 = TATARU
        {
      ...
      case 255:
      {
        if( param1 == 1012313 || param2 == 1012313 ) // ACTOR7 = HAURCHEFANT
        {
        ...
        if( param1 == 1012314 || param2 == 1012314 ) // ACTOR8 = ALPHINAUD
        {
          Scene00017( player ); // Scene00017: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1012315 || param2 == 1012315 ) // ACTOR9 = TATARU
        {
          Scene00018( player ); // Scene00018: Normal(Talk, TargetCanMove), id=TATARU
          break;
        }
        if( param1 == 1013101 || param2 == 1013101 ) // ACTOR10 = HOUSEFORTEMPSGUARD01580
        {
...
private:
  ...
  {
    player.sendDebug( "HeaVna101:67116 calling Scene00001: Normal(CutScene, QuestAccept), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "HeaVna101:67116 calling Scene00005: Normal(Talk, YesNo, TargetCanMove, CanCancel), id=TEMPLEKNIGHT01580" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 == 512 || ( result.param1 > 0 && result.param2 == 1 ) )
      {
        ...
        player.forceZoneing( 418, 0.0f, -2.6f, 141.3f, -3.14f, true );
      }
    };
  ...
  void Scene00008( Entity::Player& player ) //SEQ_3: BASE_ID_TERRITORY_TYPE, <No Var>, <No Flag>
  {
  ...
  void Scene00012( Entity::Player& player ) //SEQ_4: ACTOR4, UI8AL = 1, Flag8(1)=True
  {
    player.sendDebug( "HeaVna101:67116 calling Scene00012: Normal(Talk, NpcDespawn, TargetCanMove, ENpcBind), id=BUTLER01580" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
      player.setQuestBitFlag8( getId(), 1, true );
  ...
  void Scene00015( Entity::Player& player ) //SEQ_255: ACTOR7, <No Var>, <No Flag>
  {
  ...
  {
    player.sendDebug( "HeaVna101:67116 calling Scene00016: Normal(CutScene, QuestComplete, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
