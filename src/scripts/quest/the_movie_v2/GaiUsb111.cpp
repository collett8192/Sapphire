...
// Quest Script: GaiUsb111_00830
// Quest Name: U Don't Know Me
// Quest ID: 66366
// Start NPC: 1006288
// End NPC: 1006287
...
//    static constexpr auto Actor0 = 1006288;
//    static constexpr auto Actor1 = 1006287;
//    static constexpr auto Actor2 = 1006737;
//    static constexpr auto Enemy0 = 2268;
//    static constexpr auto Item0 = 2000647;
//    static constexpr auto Item1 = 2000648;
...
case 3:{
//if( actorId == 2268 && player.getQuestUI8BL( getId() ) != 3 ) { Scene?????( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1006737 ) { Scene00004( player ); }
break;
}
case 4:{
Scene00005( player );
...
if( actor == 1006287 ) { Scene00007( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1006737 ) { Scene00008( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling Talk, QuestReward, QuestComplete:Scene00007 ACTOR1", getId() );
