...
if( actor == 2002231 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2002233 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00003( player ); }
//EOBJECT2, null, 0, -2, False
if( actor == 2002230 ) { Scene00004( player ); }
//if( actorId == 4300120 && player.getQuestUI8CH( getId() ) != 3 ) { Scene?????( player ); }
//if( actorId == 4300124 && player.getQuestUI8CH( getId() ) != 3 ) { Scene?????( player ); }
//if( actorId == 4300125 && player.getQuestUI8CH( getId() ) != 3 ) { Scene?????( player ); }
//EOBJECT3, null, 0, -2, False
if( actor == 2002232 ) { Scene00005( player ); }
//if( actorId == 4300128 && player.getQuestUI8CL( getId() ) != 1 ) { Scene?????( player ); }
//EOBJECT4, UI8BL, 1, -2, False
if( actor == 2002234 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00006( player ); }
break;
}
case 255:{
Scene00012( player );
...
player.sendDebug( "questId: {}, calling Inventory:Scene00004 EOBJECT2", getId() );
...
player.sendDebug( "questId: {}, calling Inventory:Scene00006 EOBJECT4:UI8BL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:SkippedMsg](7)Inventory:Scene00008 ", getId() );
...
player.sendDebug( "questId: {}, calling [sub:SkippedMsg](9)Inventory:Scene00010 ", getId() );
