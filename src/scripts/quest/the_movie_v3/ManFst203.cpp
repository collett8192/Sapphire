...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( param1 == 1004472 || param2 == 1004472 ) // ACTOR2 = YELLOWJACKET
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00003( player ); // Scene00003: Normal(Talk, Message, TargetCanMove, SystemTalk), id=YELLOWJACKET
          }
          break;
        }
        if( param1 == 1004473 || param2 == 1004473 ) // ACTOR3 = AVERE
        {
          Scene00004( player ); // Scene00004: Normal(Talk, TargetCanMove), id=AVERE
          break;
        }
        if( param1 == 1004474 || param2 == 1004474 ) // ACTOR4 = LIAVINNE
        {
          Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=LIAVINNE
          break;
        }
        if( param1 == 1004475 || param2 == 1004475 ) // ACTOR5 = PAIYOREIYO
        {
          Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=PAIYOREIYO
          break;
        }
        if( param1 == 1004476 || param2 == 1004476 ) // ACTOR6 = EDDA
        {
          Scene00007( player ); // Scene00007: Normal(Talk, TargetCanMove), id=EDDA
          break;
        }
        if( param1 == 1004477 || param2 == 1004477 ) // ACTOR7 = ISILDAURE
        {
          Scene00008( player ); // Scene00008: Normal(Talk, TargetCanMove), id=ISILDAURE
          break;
        }
        if( param1 == 1004478 || param2 == 1004478 ) // ACTOR8 = ALIANNE
        {
      ...
      case 3:
      {
        ...
        if( param1 == 1004474 || param2 == 1004474 ) // ACTOR4 = LIAVINNE
        {
          Scene00012( player ); // Scene00012: Normal(Talk, TargetCanMove), id=LIAVINNE
          break;
        }
        if( param1 == 1004475 || param2 == 1004475 ) // ACTOR5 = PAIYOREIYO
        {
          Scene00013( player ); // Scene00013: Normal(Talk, TargetCanMove), id=PAIYOREIYO
          break;
        }
        if( param1 == 1004476 || param2 == 1004476 ) // ACTOR6 = EDDA
        {
          Scene00014( player ); // Scene00014: Normal(Talk, TargetCanMove), id=EDDA
          break;
        }
        if( param1 == 1004477 || param2 == 1004477 ) // ACTOR7 = ISILDAURE
        {
        ...
        if( param1 == 1004472 || param2 == 1004472 ) // ACTOR2 = YELLOWJACKET
        {
          Scene00017( player ); // Scene00017: Normal(Talk, TargetCanMove, SystemTalk), id=YELLOWJACKET
          break;
        }
        break;
      }
      case 255:
      {
        if( type != 2 ) Scene00018( player ); // Scene00018: Normal(Talk, Message, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=BADERON
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "ManFst203:66211 calling Scene00001: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=BADERON" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_2: ACTOR1, <No Var>, <No Flag>
  {
  ...
  void Scene00014( Entity::Player& player ) //SEQ_3: ACTOR6, <No Var>, <No Flag>
  {
  ...
  void Scene00015( Entity::Player& player ) //SEQ_3: ACTOR7, <No Var>, <No Flag>
  {
  ...
  void Scene00016( Entity::Player& player ) //SEQ_3: ACTOR8, <No Var>, <No Flag>
  {
