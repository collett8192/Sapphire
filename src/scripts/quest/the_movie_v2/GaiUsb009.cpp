...
if( actor == 1006280 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR2, UI8BH, 1, -2, False
if( actor == 1006281 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR3, UI8BL, 1, -2, False
if( actor == 1006282 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00004( player ); }
break;
}
case 255:{
Scene00005( player );
