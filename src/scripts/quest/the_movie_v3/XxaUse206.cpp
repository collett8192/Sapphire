...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 255:
      {
        if( type != 2 ) Scene00010( player ); // Scene00010: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=HOUZAN
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00007( Entity::Player& player ) //SEQ_3: ACTOR4, UI8AL = 3, Flag8(2)=True
  {
  ...
  void Scene00008( Entity::Player& player ) //SEQ_3: ACTOR5, UI8AL = 3, Flag8(3)=True
  {
