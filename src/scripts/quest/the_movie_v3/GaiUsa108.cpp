...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001920 || param2 == 2001920 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4278237 || param2 == 4278237 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4278233 || param2 == 4278233 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 2001921 || param2 == 2001921 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 4278251 || param2 == 4278251 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 255:
      {
        if( type != 2 ) Scene00006( player ); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AMMEXIA
        break;
      }
      default:
      {
