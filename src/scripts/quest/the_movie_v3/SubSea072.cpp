...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( type != 2 ) Scene00000( player ); // Scene00000: Normal(Talk, QuestOffer, QuestAccept, TargetCanMove), id=LOETRSWYS
        break;
      }
      case 1:
      {
        if( param1 == 1002654 || param2 == 1002654 ) // ACTOR1 = RJUMANI
        {
        ...
        if( param1 == 1002655 || param2 == 1002655 ) // ACTOR2 = ESHUSHU
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
        ...
        if( param1 == 1002656 || param2 == 1002656 ) // ACTOR3 = WAENTZIRN
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
      ...
      case 255:
      {
        if( type != 2 ) Scene00004( player ); // Scene00004: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=WEITZAREN
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00001( Entity::Player& player ) //SEQ_1: ACTOR1, UI8AL = 3, Flag8(1)=True
  {
  ...
  void Scene00002( Entity::Player& player ) //SEQ_1: ACTOR2, UI8AL = 3, Flag8(2)=True
  {
  ...
  void Scene00003( Entity::Player& player ) //SEQ_1: ACTOR3, UI8AL = 3, Flag8(3)=True
  {
