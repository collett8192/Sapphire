...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=MOEGRAMM
        break;
      }
      //seq 2 event item ITEM0 = UI8BH max stack 1
      case 2:
      {
        Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=BROENRUHT
        break;
      }
...
private:
  ...
  {
    player.sendDebug( "SubSea074:66022 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=LOETRSWYS" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "SubSea074:66022 calling [BranchTrue]Scene00005: Normal(Talk, TargetCanMove), id=OSTFYR" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
