...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1009996 || param2 == 1009996 ) // ACTOR1 = ALPHINAUD
        {
        ...
        if( param1 == 1010042 || param2 == 1010042 ) // ACTOR2 = MOENBRYDA
        {
      ...
      case 3:
      {
        if( param1 == 1010054 || param2 == 1010054 ) // ACTOR3 = TEMPLER00075
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 5:
      {
        if( type != 2 ) Scene00012( player ); // Scene00012: Normal(CutScene), id=unknown
        break;
      }
      case 255:
      {
        if( type != 2 ) Scene00013( player ); // Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=MOENBRYDA
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUse415:65620 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=MINFILIA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUse415:65620 calling Scene00003: Normal(CutScene), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00005( Entity::Player& player ) //SEQ_2: ACTOR1, UI8AL = 1, Flag8(1)=True
  {
  ...
  void Scene00010( Entity::Player& player ) //SEQ_4: ACTOR1, <No Var>, <No Flag>
  {
