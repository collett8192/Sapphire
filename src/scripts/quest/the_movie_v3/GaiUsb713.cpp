...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002134 || param2 == 2002134 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4293085 || param2 == 4293085 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4293087 || param2 == 4293087 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4293088 || param2 == 4293088 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 255:
      {
        if( type != 2 ) Scene00004( player ); // Scene00004: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=MIAHMOLKOT
        break;
      }
      default:
      {
