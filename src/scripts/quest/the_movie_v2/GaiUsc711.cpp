...
// Quest Script: GaiUsc711_01023
// Quest Name: U! Ow! That Stings
// Quest ID: 66559
// Start NPC: 1004917
// End NPC: 1004917
...
//    static constexpr auto Actor1 = 1006606;
//    static constexpr auto Actor2 = 1006607;
//    static constexpr auto Actor3 = 1006608;
//    static constexpr auto Actor4 = 1007577;
//    static constexpr auto Actor5 = 1007578;
//    static constexpr auto Actor6 = 1007579;
//    static constexpr auto Actor7 = 1007580;
//    static constexpr auto Actor8 = 1007581;
//    static constexpr auto Item0 = 2000780;
...
if( actor == 1006606 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00002( player ); }
//ACTOR2, UI8AL, 3, -2, False
if( actor == 1006607 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00004( player ); }
//ACTOR3, UI8AL, 3, -2, False
if( actor == 1006608 && player.getQuestUI8AL( getId() ) != 3 ) { Scene00006( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1007577 ) { Scene00008( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1007578 ) { Scene00009( player ); }
//ACTOR6, null, 0, -2, False
if( actor == 1007579 ) { Scene00010( player ); }
//ACTOR7, null, 0, -2, False
if( actor == 1007580 ) { Scene00011( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1007581 ) { Scene00012( player ); }
break;
}
case 255:{
Scene00013( player );
