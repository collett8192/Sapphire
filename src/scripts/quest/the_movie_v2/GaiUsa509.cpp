...
//    static constexpr auto Actor0 = 1006217;
//    static constexpr auto Actor1 = 1006702;
//    static constexpr auto Actor2 = 1006703;
//    static constexpr auto Actor3 = 1006704;
//    static constexpr auto Item0 = 2000607;
...
if( actor == 1006702 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR2, UI8BH, 1, -1, False
if( actor == 1006703 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//ACTOR3, UI8BL, 1, -1, False
if( actor == 1006704 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00006( player ); }
break;
}
case 255:{
Scene00008( player );
