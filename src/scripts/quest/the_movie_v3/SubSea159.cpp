...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( type != 2 ) Scene00000( player ); // Scene00000: Normal(Talk, QuestOffer, TargetCanMove), id=DODOZAN
        // +Callback Scene00001: Normal(QuestAccept), id=unknown
        break;
      }
      case 1:
      {
        if( param1 == 1007960 || param2 == 1007960 ) // ACTOR1 = MERCHANT01426
        {
        ...
        if( param1 == 1007961 || param2 == 1007961 ) // ACTOR2 = DELIVERYMAN01426
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
        ...
        if( param1 == 1007962 || param2 == 1007962 ) // ACTOR3 = FISHWOMAN01426
        {
          if( player.getQuestUI8AL( getId() ) != 3 )
          {
      ...
      case 2:
      {
        if( param1 == 1007797 || param2 == 1007797 ) // ACTOR4 = STAFF01426
        {
        ...
        if( param1 == 1007959 || param2 == 1007959 ) // ACTOR5 = unknown
        {
          Scene00009( player ); // Scene00009: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007976 || param2 == 1007976 ) // ACTOR6 = unknown
        {
          Scene00010( player ); // Scene00010: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007975 || param2 == 1007975 ) // ACTOR7 = unknown
        {
          Scene00011( player ); // Scene00011: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007977 || param2 == 1007977 ) // ACTOR8 = unknown
        {
          Scene00012( player ); // Scene00012: Normal(None), id=unknown
          break;
        }
        if( param1 == 1007796 || param2 == 1007796 ) // ACTOR9 = unknown
        {
      ...
      case 255:
      {
        ...
        // +Callback Scene00018: Normal(Talk, QuestReward, QuestComplete, TargetCanMove, SystemTalk), id=DODOZAN
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "SubSea159:66962 calling Scene00001: Normal(QuestAccept), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "SubSea159:66962 calling Scene00003: Normal(Talk, TargetCanMove), id=MERCHANT01426" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "SubSea159:66962 calling Scene00005: Normal(Talk, TargetCanMove), id=DELIVERYMAN01426" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
  ...
  {
    player.sendDebug( "SubSea159:66962 calling Scene00007: Normal(Talk, TargetCanMove), id=FISHWOMAN01426" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
  ...
  void Scene00016( Entity::Player& player ) //SEQ_2: ACTOR3, <No Var>, <No Flag>
  {
  ...
  {
    player.sendDebug( "SubSea159:66962 calling Scene00018: Normal(Talk, QuestReward, QuestComplete, TargetCanMove, SystemTalk), id=DODOZAN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
