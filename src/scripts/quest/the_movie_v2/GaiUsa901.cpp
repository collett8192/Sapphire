...
//    static constexpr auto Actor1 = 1006253;
//    static constexpr auto Actor2 = 1006254;
//    static constexpr auto Actor3 = 1006258;
//    static constexpr auto Item0 = 2000626;
...
if( actor == 1006253 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR2, UI8BH, 1, -1, False
if( actor == 1006254 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//ACTOR3, UI8BL, 1, -1, False
if( actor == 1006258 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00006( player ); }
break;
}
case 255:{
Scene00008( player );
