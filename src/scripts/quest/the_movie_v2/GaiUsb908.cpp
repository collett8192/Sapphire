...
// Quest Script: GaiUsb908_00931
// Quest Name: Rubble Rouser
// Quest ID: 66467
// Start NPC: 1006456
// End NPC: 1006456
...
//    static constexpr auto Actor0 = 1006456;
//    static constexpr auto Eobject0 = 2002159;
//    static constexpr auto Eobject1 = 2002160;
//    static constexpr auto Eobject2 = 2002161;
//    static constexpr auto Eobject3 = 2002162;
//    static constexpr auto Eobject4 = 2002163;
...
if( actor == 2002159 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2002160 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00004( player ); }
//EOBJECT2, UI8BL, 1, -2, False
if( actor == 2002161 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00006( player ); }
//EOBJECT3, UI8CH, 1, -2, False
if( actor == 2002162 && player.getQuestUI8CH( getId() ) != 1 ) { Scene00008( player ); }
//EOBJECT4, UI8CL, 1, -2, False
if( actor == 2002163 && player.getQuestUI8CL( getId() ) != 1 ) { Scene00010( player ); }
break;
}
case 255:{
Scene00012( player );
