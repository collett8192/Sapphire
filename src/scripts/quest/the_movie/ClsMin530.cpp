...
class ClsMin530 : public Sapphire::ScriptAPI::EventScript
{
  private:
...
//    static constexpr auto Ritem0 = 12534;
  ...
  public:
    ClsMin530() : Sapphire::ScriptAPI::EventScript( 67617 ){}; 
    ~ClsMin530() = default; 
