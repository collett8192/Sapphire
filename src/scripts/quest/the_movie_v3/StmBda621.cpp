...
class StmBda621 : public Sapphire::ScriptAPI::QuestScript
{
public:
  StmBda621() : Sapphire::ScriptAPI::QuestScript( 68083 ){}; 
  ~StmBda621() = default; 
  ...
  void onProgress( World::Quest& quest, Entity::Player& player, uint32_t type, uint64_t param1, uint32_t param2, uint32_t param3 )
  {
    switch( quest.getSeq() )
    {
      case 0:
      {
        ...
        if( param1 == 1020651 ) // ACTOR1 = unknown
        {
          Scene00002( quest, player ); // Scene00002: Empty(None), id=unknown
          break;
        }
        if( param1 == 1020652 ) // ACTOR2 = unknown
        {
          Scene00003( quest, player ); // Scene00003: Empty(None), id=unknown
          break;
        }
        if( param1 == 1020660 ) // ACTOR3 = MNAAGO
        {
          Scene00004( quest, player ); // Scene00004: Normal(Talk, TargetCanMove), id=MNAAGO
          break;
        }
        if( param1 == 1020446 ) // ACTOR4 = ALPHINAUD
        {
          Scene00005( quest, player ); // Scene00005: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1020438 ) // ACTOR5 = STARKWOAD
        {
          Scene00006( quest, player ); // Scene00006: Normal(Talk, TargetCanMove), id=STARKWOAD
          break;
        }
        if( param1 == 1020650 ) // ACTOR6 = SERPENTOFFICER
        {
      ...
      case 1:
      {
        if( param1 == 1019486 ) // ACTOR7 = ORELLA
        {
          if( quest.getUI8AL() != 1 )
          {
            Scene00008( quest, player ); // Scene00008: Normal(Talk, TargetCanMove), id=ORELLA
            // +Callback Scene00009: Normal(Talk, FadeIn, TargetCanMove, AutoFadeIn, CreateCharacterTalk), id=ORELLA
          }
          break;
        }
        if( param1 == 1020651 ) // ACTOR1 = unknown
        ...
        if( param1 == 1020438 ) // ACTOR5 = STARKWOAD
        {
          Scene00013( quest, player ); // Scene00013: Normal(Talk, TargetCanMove), id=STARKWOAD
          break;
        }
        if( param1 == 1020650 ) // ACTOR6 = SERPENTOFFICER
        {
      ...
      case 2:
      {
        if( param1 == 2008216 ) // EOBJECT0 = unknown
        {
          if( quest.getUI8AL() != 1 )
          {
        ...
        if( param1 == 1020357 ) // ACTOR8 = ALISAIE
        {
        ...
        if( param1 == 1020412 ) // ACTOR9 = ALPHINAUD
        {
      ...
      case 255:
      {
        if( param1 == 1020665 ) // ACTOR10 = LYSE
        {
          Scene00022( quest, player ); // Scene00022: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=LYSE
          break;
        }
        if( param1 == 1020357 ) // ACTOR8 = ALISAIE
        {
        ...
        if( param1 == 1020650 ) // ACTOR6 = SERPENTOFFICER
        {
          Scene00027( quest, player ); // Scene00027: Normal(Talk, TargetCanMove), id=SERPENTOFFICER
          break;
        }
        break;
      }
...
private:
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove, ENpcBind), id=LYSE" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00002: Empty(None), id=unknown" );
  }

  void Scene00003( World::Quest& quest, Entity::Player& player ) //SEQ_0: ACTOR2, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00003: Empty(None), id=unknown" );
  }

  void Scene00004( World::Quest& quest, Entity::Player& player ) //SEQ_0: ACTOR3, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00004: Normal(Talk, TargetCanMove), id=MNAAGO" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00005: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00006: Normal(Talk, TargetCanMove), id=STARKWOAD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00007: Normal(Talk, TargetCanMove), id=SERPENTOFFICER" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00008: Normal(Talk, TargetCanMove), id=ORELLA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00009: Normal(Talk, FadeIn, TargetCanMove, AutoFadeIn, CreateCharacterTalk), id=ORELLA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      quest.setUI8AL( 1 );
    ...
    eventMgr().playQuestScene( player, getId(), 9, FADE_OUT | CONDITION_CUTSCENE | HIDE_UI | INVIS_ENPC, callback );
  }

  void Scene00010( World::Quest& quest, Entity::Player& player ) //SEQ_1: ACTOR1, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00010: Empty(None), id=unknown" );
  }

  void Scene00011( World::Quest& quest, Entity::Player& player ) //SEQ_1: ACTOR2, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00011: Empty(None), id=unknown" );
  }

  void Scene00012( World::Quest& quest, Entity::Player& player ) //SEQ_1: ACTOR0, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00012: Normal(Talk, TargetCanMove), id=LYSE" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00013: Normal(Talk, TargetCanMove), id=STARKWOAD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00014: Normal(Talk, TargetCanMove), id=SERPENTOFFICER" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  void Scene00016( World::Quest& quest, Entity::Player& player ) //SEQ_2: EOBJECT0, UI8AL = 1, Flag8(1)=True(Todo:1)
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00016: Normal(CutScene), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      quest.setUI8AL( 1 );
      quest.setBitFlag8( 1, true );
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00017: Normal(Talk, TargetCanMove), id=ALISAIE" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00018: Empty(None), id=unknown" );
  }

  void Scene00019( World::Quest& quest, Entity::Player& player ) //SEQ_2: ACTOR2, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00019: Empty(None), id=unknown" );
  }

  void Scene00020( World::Quest& quest, Entity::Player& player ) //SEQ_2: ACTOR9, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00020: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00021: Normal(Talk, TargetCanMove), id=SERPENTOFFICER" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00022: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=LYSE" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      if( result.numOfResults > 0 && result.getResult( 0 ) == 1 )
      {
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00023: Normal(Talk, TargetCanMove), id=ALISAIE" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00024: Empty(None), id=unknown" );
  }

  void Scene00025( World::Quest& quest, Entity::Player& player ) //SEQ_255: ACTOR2, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00025: Empty(None), id=unknown" );
  }

  void Scene00026( World::Quest& quest, Entity::Player& player ) //SEQ_255: ACTOR9, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00026: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "StmBda621:68083 calling Scene00027: Normal(Talk, TargetCanMove), id=SERPENTOFFICER" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
