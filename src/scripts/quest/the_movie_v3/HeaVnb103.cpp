...
// param used:
//WARP_SCENE9 = 399|-531|152.9|-487|0.219|false
...
class HeaVnb103 : public Sapphire::ScriptAPI::QuestScript
{
public:
  HeaVnb103() : Sapphire::ScriptAPI::QuestScript( 67694 ){}; 
  ~HeaVnb103() = default; 
...
private:
  void onProgress( World::Quest& quest, Entity::Player& player, uint32_t type, uint64_t param1, uint32_t param2, uint32_t param3 )
  {
    switch( quest.getSeq() )
    {
      case 0:
      {
        if( param1 == 1015983 ) // ACTOR0 = ALPHINAUD
        {
          if( quest.getUI8AL() != 1 )
          {
      ...
      case 1:
      {
        if( param1 == 1015987 ) // ACTOR3 = YSHTOLA
        {
          if( quest.getUI8AL() != 1 )
          {
            Scene00004( quest, player ); // Scene00004: Normal(Talk, TargetCanMove, ENpcBind), id=YSHTOLA
          }
          break;
        }
        if( param1 == 1015984 ) // ACTOR1 = LUCIA
        ...
        if( param1 == 1015986 ) // ACTOR4 = ALPHINAUD
        {
      ...
      case 2:
      {
        if( param1 == 2006605 ) // EOBJECT0 = unknown
        {
          if( quest.getUI8AL() != 1 )
          {
        ...
        if( param1 == 1015988 ) // ACTOR5 = ALPHINAUD
        {
          Scene00010( quest, player ); // Scene00010: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1015989 ) // ACTOR6 = YSHTOLA
        {
          Scene00011( quest, player ); // Scene00011: Normal(Talk, TargetCanMove), id=YSHTOLA
          break;
        }
        if( param1 == 1012163 ) // ACTOR7 = HANDELOUP
        {
          Scene00012( quest, player ); // Scene00012: Normal(Talk, TargetCanMove), id=HANDELOUP
          break;
        }
        break;
      }
      case 255:
      {
        if( param1 == 1015992 ) // ACTOR8 = KRILE
        {
          Scene00013( quest, player ); // Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=KRILE
          break;
        }
        if( param1 == 1012422 ) // ACTOR9 = ALPHINAUD
        {
          Scene00014( quest, player ); // Scene00014: Normal(Talk, TargetCanMove), id=ALPHINAUD
          break;
        }
        if( param1 == 1012423 ) // ACTOR10 = YSHTOLA
        {
...
private:
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00001: Normal(Talk, NpcDespawn, QuestAccept, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00002: Normal(Talk, TargetCanMove), id=LUCIA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00003: Empty(None), id=unknown" );
  }

  void Scene00004( World::Quest& quest, Entity::Player& player ) //SEQ_1: ACTOR3, UI8AL = 1, Flag8(1)=True(Todo:0)
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00004: Normal(Talk, TargetCanMove, ENpcBind), id=YSHTOLA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      quest.setUI8AL( 1 );
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00005: Normal(Talk, TargetCanMove), id=LUCIA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00006: Empty(None), id=unknown" );
  }

  void Scene00007( World::Quest& quest, Entity::Player& player ) //SEQ_1: ACTOR4, <No Var>, <No Flag>
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00007: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  void Scene00009( World::Quest& quest, Entity::Player& player ) //SEQ_2: EOBJECT0, UI8AL = 1, Flag8(1)=True(Todo:1)
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00009: Normal(CutScene), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      quest.setUI8AL( 1 );
      quest.setBitFlag8( 1, true );
      ...
      player.forceZoneing( 399, -531.0f, 152.9f, -487.0f, 0.22f, false );
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00010: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00011: Normal(Talk, TargetCanMove), id=YSHTOLA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00012: Normal(Talk, TargetCanMove), id=HANDELOUP" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00013: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=KRILE" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      if( result.numOfResults > 0 && result.getResult( 0 ) == 1 )
      {
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00014: Normal(Talk, TargetCanMove), id=ALPHINAUD" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00015: Normal(Talk, TargetCanMove), id=YSHTOLA" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "HeaVnb103:67694 calling Scene00016: Normal(Talk, TargetCanMove), id=HANDELOUP" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
