...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001420 || param2 == 2001420 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2001599 || param2 == 2001599 ) // EOBJECT1 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 5 )
          {
        ...
        if( param1 == 2001600 || param2 == 2001600 ) // EOBJECT2 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 5 )
          {
        ...
        if( param1 == 2001601 || param2 == 2001601 ) // EOBJECT3 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 5 )
          {
        ...
        if( param1 == 2001602 || param2 == 2001602 ) // EOBJECT4 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 5 )
          {
      ...
      case 255:
      {
        if( type != 2 ) Scene00011( player ); // Scene00011: NpcTrade(Talk, TargetCanMove), id=BENEGER
...
private:
  ...
  {
    player.sendDebug( "SubWil124:66170 calling Scene00002: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "SubWil124:66170 calling Scene00004: Normal(None), id=unknown" );
    player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
  ...
  {
    player.sendDebug( "SubWil124:66170 calling Scene00006: Normal(None), id=unknown" );
    player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
  ...
  {
    player.sendDebug( "SubWil124:66170 calling Scene00008: Normal(None), id=unknown" );
    player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
  ...
  {
    player.sendDebug( "SubWil124:66170 calling Scene00010: Normal(None), id=unknown" );
    player.setQuestUI8AL( getId(), player.getQuestUI8AL( getId() ) + 1 );
