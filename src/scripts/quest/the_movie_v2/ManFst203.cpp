...
//    static constexpr auto Actor2 = 1004472;
//    static constexpr auto Actor3 = 1004473;
//    static constexpr auto Actor4 = 1004474;
//    static constexpr auto Actor5 = 1004475;
//    static constexpr auto Actor6 = 1004476;
//    static constexpr auto Actor7 = 1004477;
//    static constexpr auto Actor8 = 1004478;
...
if( actor == 1004472 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1004473 ) { Scene00004( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1004474 ) { Scene00005( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1004475 ) { Scene00006( player ); }
//ACTOR6, null, 0, -2, False
if( actor == 1004476 ) { Scene00007( player ); }
//ACTOR7, null, 0, -2, False
if( actor == 1004477 ) { Scene00008( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1004478 ) { Scene00009( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1003621 ) { Scene00010( player ); }
break;
}
case 3:{
//ACTOR3, null, 0, -2, False
if( actor == 1004473 ) { Scene00011( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1004474 ) { Scene00012( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1004475 ) { Scene00013( player ); }
//ACTOR6, null, 0, -2, False
if( actor == 1004476 ) { Scene00014( player ); }
//ACTOR7, null, 0, -2, False
if( actor == 1004477 ) { Scene00015( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1004478 ) { Scene00016( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1004472 ) { Scene00017( player ); }
break;
}
case 255:{
Scene00018( player );
...
player.sendDebug( "questId: {}, calling Talk:Scene00009 ACTOR8", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00016 ACTOR8", getId() );
...
player.sendDebug( "questId: {}, calling Talk, QuestReward, QuestComplete, Message, FadeOut:Scene00018 ", getId() );
