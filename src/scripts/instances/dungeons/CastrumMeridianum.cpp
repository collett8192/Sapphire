...
const uint32_t FFXIV_THE_MOVIE_INSTANCE_QUEST_ID = 69409;
const uint8_t FFXIV_THE_MOVIE_INSTANCE_QUEST_SEQ_REQUIRED = 2;
const uint8_t FFXIV_THE_MOVIE_INSTANCE_QUEST_SEQ_TARGET = 255;
const uint32_t SCENE_LIST[] = { 267, 268, 269, 270, 271, 272, 273, 274, 276, 275, 277, 0 }; // 276 before 275 is not a mistake
//===========THE_MOVIE end============
