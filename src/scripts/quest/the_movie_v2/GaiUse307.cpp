...
// Quest Script: GaiUse307_01448
// Quest Name: Lord of Levin
// Quest ID: 66984
// Start NPC: 1008579
// End NPC: 1009097
...
//    static constexpr auto Actor1 = 1009089;
//    static constexpr auto Actor10 = 1000460;
//    static constexpr auto Actor11 = 1009097;
//    static constexpr auto Actor2 = 1000168;
//    static constexpr auto Actor3 = 1008969;
//    static constexpr auto Actor4 = 1003027;
//    static constexpr auto Actor5 = 1009091;
//    static constexpr auto Actor6 = 1009092;
//    static constexpr auto Actor7 = 1009093;
//    static constexpr auto Actor8 = 1009094;
//    static constexpr auto Actor9 = 1009090;
//    static constexpr auto CutSceneN01 = 533;
//    static constexpr auto EventActionSearch = 1;
//    static constexpr auto LocActor0 = 1008176;
//    static constexpr auto LocActor1 = 1008177;
//    static constexpr auto LocActor2 = 1008178;
//    static constexpr auto LocActor3 = 1008179;
//    static constexpr auto LocActor4 = 4866717;
...
if( actor == 1008579 ) { Scene00000( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1009089 ) { Scene00002( player ); }
break;
}
case 1:{
//ACTOR2, UI8AL, 1, -2, False
if( actor == 1000168 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR1, null, 0, -2, False
if( actor == 1009089 ) { Scene00004( player ); }
...
if( actor == 1003027 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00007( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1009091 ) { Scene00008( player ); }
//ACTOR6, null, 0, -2, False
if( actor == 1009092 ) { Scene00009( player ); }
//ACTOR7, null, 0, -2, False
if( actor == 1009093 ) { Scene00010( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1009094 ) { Scene00011( player ); }
//ACTOR9, null, 0, -2, False
if( actor == 1009090 ) { Scene00012( player ); }
//ACTOR2, null, 0, -2, False
if( actor == 1000168 ) { Scene00013( player ); }
//ACTOR10, null, 0, -2, False
if( actor == 1000460 ) { Scene00014( player ); }
break;
}
case 255:{
//ACTOR11, null, 0, -2, False
if( actor == 1009097 ) { Scene00014( player ); }
//ACTOR10, null, 0, -2, False
if( actor == 1000460 ) { Scene00015( player ); }
break;
}
...
player.sendDebug( "questId: {}, calling Talk:Scene00007 ACTOR4:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling Talk, YesNo:Scene00013 ACTOR2", getId() );
...
player.sendDebug( "questId: {}, calling Talk, QuestReward, QuestComplete:Scene00014 ACTOR11", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00015 ACTOR10", getId() );
