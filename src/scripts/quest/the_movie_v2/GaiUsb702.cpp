...
//    static constexpr auto Actor1 = 1006395;
//    static constexpr auto Actor2 = 1006396;
...
if( actor == 1006395 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR2, UI8BH, 1, -2, False
if( actor == 1006396 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR3, UI8BL, 1, -2, False
if( actor == 1006377 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00004( player ); }
break;
}
case 255:{
Scene00005( player );
