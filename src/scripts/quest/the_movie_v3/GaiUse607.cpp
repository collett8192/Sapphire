...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006454 || param2 == 1006454 ) // ACTOR0 = MARCELAIN
        {
      ...
      case 3:
      {
        if( param1 == 1010978 || param2 == 1010978 ) // ACTOR2 = ALPHINAUD
        {
        ...
        if( param1 == 1006456 || param2 == 1006456 ) // ACTOR3 = CHAUNOLLET
        {
          Scene00006( player ); // Scene00006: Normal(Talk, TargetCanMove), id=CHAUNOLLET
          break;
        }
        if( param1 == 1006455 || param2 == 1006455 ) // ACTOR4 = LOANNE
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUse607:65955 calling Scene00001: Normal(Talk, Message, FadeIn, QuestAccept, TargetCanMove), id=MARCELAIN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00005( Entity::Player& player ) //SEQ_3: ACTOR0, <No Var>, <No Flag>
  {
  ...
  void Scene00006( Entity::Player& player ) //SEQ_3: ACTOR3, <No Var>, <No Flag>
  {
