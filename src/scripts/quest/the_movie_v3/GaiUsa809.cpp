...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 4286922 || param2 == 4286922 ) // EVENTRANGE0 = unknown
        {
        ...
        if( param1 == 4286954 || param2 == 4286954 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 1006249 || param2 == 1006249 ) // ACTOR1 = ADVENTURE
        {
          Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=ADVENTURE
          break;
        }
        if( param1 == 2002461 || param2 == 2002461 ) // EOBJECT0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 1006250 || param2 == 1006250 ) // ACTOR2 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1002804 || param2 == 1002804 ) // ACTOR0 = AELUUIN
        {
