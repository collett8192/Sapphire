...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 1006204 || actorId == 1006204 ) // ACTOR1 = NPCA
        {
        ...
        if( actor == 1006205 || actorId == 1006205 ) // ACTOR2 = NPCB
        {
        ...
        if( actor == 1006206 || actorId == 1006206 ) // ACTOR3 = NPCC
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa406:66284 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=HIHIBARU" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa406:66284 calling [BranchTrue]Scene00003: Normal(Talk, TargetCanMove), id=NPCA" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa406:66284 calling [BranchTrue]Scene00005: Normal(Talk, TargetCanMove), id=NPCB" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa406:66284 calling [BranchTrue]Scene00007: Normal(Talk, TargetCanMove), id=NPCC" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
