...
class GaiUsa005 : public Sapphire::ScriptAPI::EventScript
{
public:
  GaiUsa005() : Sapphire::ScriptAPI::EventScript( 66247 ){}; 
  ~GaiUsa005() = default; 
...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=ANIUD
        break;
      }
      case 2:
      {
        Scene00003( player ); // Scene00003: Normal(Talk, TargetCanMove), id=ANIUD
        break;
      }
      case 3:
      {
      ...
      case 255:
      {
        Scene00004( player ); // Scene00004: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=FLORIMOND
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa005:66247 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=FLORIMOND" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
