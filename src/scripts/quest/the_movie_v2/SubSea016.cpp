...
//    static constexpr auto Actor0 = 1003355;
//    static constexpr auto Actor1 = 1009944;
...
if( actor == 1009944 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR0, null, 0, -1, False
if( actor == 1003355 ) { Scene00005( player ); }
break;
}
case 255:{
Scene00005( player );
