...
class ManWil009 : public Sapphire::ScriptAPI::QuestScript
{
public:
  ManWil009() : Sapphire::ScriptAPI::QuestScript( 66088 ){}; 
  ~ManWil009() = default; 
...
private:
  void onProgress( World::Quest& quest, Entity::Player& player, uint32_t type, uint64_t param1, uint32_t param2, uint32_t param3 )
  {
    switch( quest.getSeq() )
    {
      ...
      case 1:
      {
        if( param1 == 1001821 ) // ACTOR1 = BARTHOLOMEW, CB=1
        {
          if( quest.getUI8AL() != 1 )
          {
            Scene00002( quest, player ); // Scene00002: Normal(Talk, TargetCanMove), id=BARTHOLOMEW
            // +Callback Scene00003: Normal(Talk, TargetCanMove), id=BARTHOLOMEW
            // +Callback Scene00004: Normal(CutScene, AutoFadeIn), id=unknown
          }
          else
          {
            Scene00005( quest, player ); // Scene00005: Normal(Talk, TargetCanMove), id=BARTHOLOMEW
          }
          break;
        }
        if( param1 == 1004093 ) // ACTOR2 = unknown
        {
          Scene00006( quest, player ); // Scene00006: Normal(Talk, TargetCanMove), id=unknown
          break;
        }
        break;
      }
      case 255:
      {
        if( type != EVENT_ON_BNPC_KILL ) Scene00008( quest, player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=RAUBAHN
        break;
      }
      default:
      {
...
private:
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00000: Normal(QuestOffer, TargetCanMove), id=unknown" );
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=MOMODI" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00002: Normal(Talk, TargetCanMove), id=BARTHOLOMEW" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00003: Normal(Talk, TargetCanMove), id=BARTHOLOMEW" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00004: Normal(CutScene, AutoFadeIn), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      quest.setUI8AL( 1 );
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00005: Normal(Talk, TargetCanMove), id=BARTHOLOMEW" );
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00006: Normal(Talk, TargetCanMove), id=unknown" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
    };
  ...
  {
    playerMgr().sendDebug( player, "ManWil009:66088 calling Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=RAUBAHN" );
    auto callback = [ & ]( World::Quest& quest, Entity::Player& player , const Event::SceneResult& result )
    {
      if( result.numOfResults > 0 && result.getResult( 0 ) == 1 )
      {
