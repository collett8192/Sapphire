...
const uint32_t FFXIV_THE_MOVIE_INSTANCE_QUEST_ID = 68080;
const uint8_t FFXIV_THE_MOVIE_INSTANCE_QUEST_SEQ_REQUIRED = 6;
const uint8_t FFXIV_THE_MOVIE_INSTANCE_QUEST_SEQ_TARGET = 7;
const uint32_t SCENE_LIST[] = { 1554, 1555, 0 };
//===========THE_MOVIE end============
