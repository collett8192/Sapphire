...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=IRIELLE
        break;
      }
      case 2:
      {
        if( param1 == 2002459 || param2 == 2002459 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 4309478 || param2 == 4309478 ) // ENEMY0 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4309481 || param2 == 4309481 ) // ENEMY1 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4309485 || param2 == 4309485 ) // ENEMY2 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4309486 || param2 == 4309486 ) // ENEMY3 = unknown
        {
          // empty entry
          break;
        }
        if( param1 == 4309487 || param2 == 4309487 ) // ENEMY4 = unknown
        {
          // empty entry
          break;
        }
      ...
      case 3:
      {
        if( type != 2 ) Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=IRIELLE
        break;
      }
      case 255:
      {
        if( type != 2 ) Scene00006( player ); // Scene00006: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=YOENNE
        break;
      }
      default:
      {
...
private:
  ...
  void Scene00004( Entity::Player& player ) //SEQ_2: EOBJECT0, UI8AL = 5, Flag8(1)=True
  {
