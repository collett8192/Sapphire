...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 4334543 || param2 == 4334543 ) // EVENTRANGE0 = unknown
        {
        ...
        if( param1 == 2002152 || param2 == 2002152 ) // EOBJECT0 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(Message), id=unknown
          break;
        }
        if( param1 == 4293186 || param2 == 4293186 ) // ENEMY0 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002512 || param2 == 2002512 ) // EOBJECT1 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb807:66452 calling Scene00006: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
