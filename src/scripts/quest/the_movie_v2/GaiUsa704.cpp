...
// Quest Script: GaiUsa704_00777
// Quest Name: The Bear and the Young'uns' Cares
// Quest ID: 66313
// Start NPC: 1006215
// End NPC: 1006215
...
//    static constexpr auto Actor1 = 1006221;
//    static constexpr auto Actor2 = 1006222;
//    static constexpr auto Actor3 = 1006223;
...
if( actor == 1006221 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//ACTOR2, UI8BH, 1, -2, False
if( actor == 1006222 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00003( player ); }
//ACTOR3, UI8BL, 1, -2, False
if( actor == 1006223 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00004( player ); }
//ACTOR4, UI8CH, 1, -2, False
if( actor == 1006224 && player.getQuestUI8CH( getId() ) != 1 ) { Scene00005( player ); }
break;
}
case 255:{
Scene00006( player );
