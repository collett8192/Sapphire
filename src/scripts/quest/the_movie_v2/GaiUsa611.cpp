...
// Quest Script: GaiUsa611_00773
// Quest Name: Masher for a Day
// Quest ID: 66309
// Start NPC: 1000340
// End NPC: 1006238
...
//    static constexpr auto Actor0 = 1000340;
//    static constexpr auto Actor1 = 1000341;
//    static constexpr auto Actor2 = 1006238;
//    static constexpr auto Eobject0 = 2001975;
//    static constexpr auto Eobject1 = 2002281;
//    static constexpr auto Eobject2 = 2002282;
//    static constexpr auto Eobject3 = 2001976;
//    static constexpr auto EventActionProcessUpperMiddle = 32;
//    static constexpr auto Item0 = 2000610;
//    static constexpr auto Item1 = 2000835;
//    static constexpr auto Item2 = 2000836;
//    static constexpr auto Item3 = 2000611;
...
if( actor == 2001975 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00002( player ); }
//EOBJECT1, UI8BH, 1, -2, False
if( actor == 2002281 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00005( player ); }
//EOBJECT2, UI8BL, 1, -2, False
if( actor == 2002282 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00008( player ); }
break;
}
case 2:{
Scene00009( player );
...
player.sendDebug( "questId: {}, calling [sub:BranchFalse](2)Empty:Scene00004 ", getId() );
...
player.sendDebug( "questId: {}, calling NpcTrade:Scene00008 EOBJECT2:UI8BL=-2, 1", getId() );
