...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 2:
      {
        if( param1 == 1010054 || param2 == 1010054 ) // ACTOR2 = TEMPLER00075
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
...
private:
  ...
  {
    player.sendDebug( "GaiUsd020:65626 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=URIANGER" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00007( Entity::Player& player ) //SEQ_3: ACTOR0, <No Var>, <No Flag>
  {
  ...
  void Scene00011( Entity::Player& player ) //SEQ_4: ACTOR0, <No Var>, <No Flag>
  {
  ...
  void Scene00012( Entity::Player& player ) //SEQ_4: ACTOR2, <No Var>, <No Flag>
  {
