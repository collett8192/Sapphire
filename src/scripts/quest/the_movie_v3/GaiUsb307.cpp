...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002059 || param2 == 2002059 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002060 || param2 == 2002060 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002061 || param2 == 2002061 ) // EOBJECT2 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb307:66384 calling Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb307:66384 calling Scene00005: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsb307:66384 calling Scene00007: Normal(None), id=unknown" );
