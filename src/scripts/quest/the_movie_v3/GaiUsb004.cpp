...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1006265 || param2 == 1006265 ) // ACTOR1 = unknown
        {
        ...
        if( param1 == 2002284 || param2 == 2002284 ) // EOBJECT0 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00005( player ); // Scene00005: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove), id=WHEISKAET
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb004:66347 calling Scene00090: Normal(Talk, FadeIn, QuestAccept, TargetCanMove), id=TRACHTOUM" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00002( Entity::Player& player ) //SEQ_1: ACTOR1, UI8AL = 1, Flag8(1)=True
  {
    ...
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
        ...
        pTeriMgr.createAndJoinQuestBattle( player, 59 );
      }
    };
  ...
  {
    player.sendDebug( "GaiUsb004:66347 calling Scene00004: Normal(None), id=unknown" );
