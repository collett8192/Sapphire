...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, FadeIn, TargetCanMove), id=ELE
        break;
      }
      case 2:
      {
      ...
      case 3:
      {
        if( type != 2 ) Scene00005( player ); // Scene00005: Normal(Talk, TargetCanMove), id=GUARDLEADER01445
        break;
      }
      case 255:
      {
...
private:
  ...
  void Scene00006( Entity::Player& player ) //SEQ_255: ACTOR5, <No Var>, <No Flag>
  {
