...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 0:
      {
        Scene00000( player ); // Scene00000: Normal(Talk, QuestOffer, QuestAccept, TargetCanMove), id=LATISHA
        break;
      }
      ...
      case 2:
      {
        Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=RSUSHMO
        break;
      }
...
private:
  ...
  {
    player.sendDebug( "SubSea007:65653 calling Scene00001: Normal(None), id=unknown" );
