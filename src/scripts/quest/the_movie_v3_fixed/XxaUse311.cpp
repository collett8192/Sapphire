    ...
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 3:
      {
        if( param1 == 1009119 || param2 == 1009119 ) // ACTOR3 = PAPALYMO
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00006( player ); // Scene00006: Normal(Talk, NpcDespawn, TargetCanMove), id=PAPALYMO
          }
          break;
        }
      ...
      case 4:
      {
        ...
        {
          Scene00012( player ); // Scene00012: Normal(FadeIn, Dismount), id=unknown
          break;
        }
      ...
      case 255:
      {
        Scene00020( player ); // Scene00020: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=LIEUTENANT01448
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "XxaUse311:69421 calling Scene00006: Normal(Talk, NpcDespawn, TargetCanMove), id=PAPALYMO" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
