...
//    static constexpr auto Enemy0 = 1450088;
//    static constexpr auto Eobject0 = 2000008;
...
if( actor == 2000008 ) { Scene00001( player ); }
//if( actorId == 1450088 && player.getQuestUI8AL( getId() ) != 1 ) { Scene?????( player ); }
break;
}
case 255:{
Scene00002( player );
