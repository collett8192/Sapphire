...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2001371 || param2 == 2001371 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2001372 || param2 == 2001372 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2001373 || param2 == 2001373 ) // EOBJECT2 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "SubWil096:66040 calling Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "SubWil096:66040 calling Scene00006: Normal(None), id=unknown" );
    player.setQuestUI8BH( getId(), 1 );
  ...
  {
    player.sendDebug( "SubWil096:66040 calling Scene00009: Normal(None), id=unknown" );
    player.setQuestUI8BL( getId(), 1 );
  ...
  {
    player.sendDebug( "SubWil096:66040 calling Scene00011: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
