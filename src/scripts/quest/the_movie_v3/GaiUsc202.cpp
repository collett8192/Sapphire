...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( type != 2 ) Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=SKYFRYN
        break;
      }
      ...
      case 2:
      {
        ...
        if( param1 == 1006502 || param2 == 1006502 ) // ACTOR1 = SKYFRYN
        {
      ...
      case 3:
      {
        if( param1 == 1006501 || param2 == 1006501 ) // ACTOR2 = MIMIDOA
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
