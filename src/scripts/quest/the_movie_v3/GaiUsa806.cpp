...
private:
  void onProgress( Entity::Player& player, uint64_t actorId, uint32_t actor, uint32_t type, uint32_t param )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( actor == 2001990 || actorId == 2001990 ) // EOBJECT0 = unknown
        {
        ...
        if( actor == 4286256 || actorId == 4286256 ) // ENEMY0 = unknown
        {
          // empty entry
        }
        if( actor == 2001991 || actorId == 2001991 ) // EOBJECT1 = unknown
        {
        ...
        if( actor == 4286261 || actorId == 4286261 ) // ENEMY1 = unknown
        {
          // empty entry
        }
        if( actor == 2001992 || actorId == 2001992 ) // EOBJECT2 = unknown
        {
        ...
        if( actor == 4286265 || actorId == 4286265 ) // ENEMY2 = unknown
        {
          // empty entry
        }
        break;
      ...
      case 255:
      {
        Scene00008( player ); // Scene00008: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=ORIANE
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsa806:66326 calling [BranchTrue]Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=ORIANE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa806:66326 calling [BranchTrue]Scene00003: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa806:66326 calling [BranchTrue]Scene00005: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsa806:66326 calling [BranchTrue]Scene00007: Normal(Message, PopBNpc), id=unknown" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
