...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      case 0:
      {
        if( param1 == 1012368 || param2 == 1012368 ) // ACTOR0 = EMMANELLAIN
        {
        ...
        if( param1 == 1012369 || param2 == 1012369 ) // ACTOR1 = HAURCHEFANT
        {
          Scene00002( player ); // Scene00002: Normal(Talk, TargetCanMove), id=HAURCHEFANT
          break;
        }
        if( param1 == 1012370 || param2 == 1012370 ) // ACTOR2 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(None), id=unknown
          break;
        }
        if( param1 == 1013091 || param2 == 1013091 ) // ACTOR3 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 1013092 || param2 == 1013092 ) // ACTOR4 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 1012371 || param2 == 1012371 ) // ACTOR5 = HONOROIT
        {
      ...
      case 1:
      {
        if( param1 == 1011952 || param2 == 1011952 ) // ACTOR6 = LANIAITTE
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00007( player ); // Scene00007: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=LANIAITTE
          }
          break;
        }
        if( param1 == 1012371 || param2 == 1012371 ) // ACTOR5 = HONOROIT
      ...
      case 2:
      {
        if( param1 == 1012375 || param2 == 1012375 ) // ACTOR7 = HAURCHEFANT
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 255:
      {
        if( param1 == 1012329 || param2 == 1012329 ) // ACTOR8 = EMMANELLAIN
        {
          Scene00016( player ); // Scene00016: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove, ENpcBind), id=EMMANELLAIN
          break;
        }
        if( param1 == 1012327 || param2 == 1012327 ) // ACTOR9 = HONOROIT
        {
...
private:
  ...
  {
    player.sendDebug( "HeaVna117:67132 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=EMMANELLAIN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "HeaVna117:67132 calling Scene00007: Normal(Talk, FadeIn, TargetCanMove, ENpcBind), id=LANIAITTE" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  void Scene00014( Entity::Player& player ) //SEQ_2: ACTOR7, UI8AL = 1, Flag8(1)=True
  {
  ...
  {
    player.sendDebug( "HeaVna117:67132 calling Scene00016: Normal(Talk, FadeIn, QuestReward, QuestComplete, TargetCanMove, ENpcBind), id=EMMANELLAIN" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
