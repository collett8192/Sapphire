...
if( actor == 1007538 ) { Scene00004( player ); }
//ACTOR3, null, 0, -2, False
if( actor == 1007539 ) { Scene00005( player ); }
//ACTOR4, null, 0, -2, False
if( actor == 1007670 ) { Scene00006( player ); }
...
if( actor == 1006567 && player.getQuestUI8BL( getId() ) != 1 ) { Scene00011( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1007537 ) { Scene00014( player ); }
//ACTOR6, null, 0, -2, True
if( actor == 1006531 ) { Scene00015( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1007614 ) { Scene00016( player ); }
//ACTOR9, UI8AL, 1, -2, False
if( actor == 1006568 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00017( player ); }
//ACTOR10, UI8BH, 1, -2, False
if( actor == 1006569 && player.getQuestUI8BH( getId() ) != 1 ) { Scene00020( player ); }
break;
}
case 3:{
//ACTOR11, UI8AL, 1, -2, False
if( actor == 1007611 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00023( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1007537 ) { Scene00026( player ); }
//ACTOR6, null, 0, -2, True
if( actor == 1006531 ) { Scene00027( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1007614 ) { Scene00028( player ); }
break;
}
case 4:{
//ACTOR12, UI8AL, 1, -2, False
if( actor == 1006562 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00029( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1007537 ) { Scene00031( player ); }
//ACTOR6, null, 0, -2, True
if( actor == 1006531 ) { Scene00032( player ); }
//ACTOR8, null, 0, -2, False
if( actor == 1007614 ) { Scene00033( player ); }
break;
}
case 5:{
//EOBJECT0, UI8AL, 1, -2, False
if( actor == 2002376 && player.getQuestUI8AL( getId() ) != 1 ) { Scene00035( player ); }
//ACTOR5, null, 0, -2, False
if( actor == 1007537 ) { Scene00036( player ); }
//ACTOR6, null, 0, -2, True
if( actor == 1006531 ) { Scene00037( player ); }
//ACTOR13, null, 0, -2, False
if( actor == 1007694 ) { Scene00038( player ); }
//ACTOR14, null, 0, -2, False
if( actor == 1007696 ) { Scene00039( player ); }
break;
}
...
default: { player.sendUrgent( "seq {} not defined.", player.getQuestSeq( getId() ) ); break; }
  ...
  void onEmote( uint64_t actorId, uint32_t eventId, uint32_t emoteId, Sapphire::Entity::Player& player ) override
  {
    ...
    switch( player.getQuestSeq( getId() ) )
    {
      case 2:
      {
        if( actor == 1006567 && player.getQuestUI8BL( getId() ) != 1 )
        {
          if( flag )
            Scene00012( player );
          else
        ...
        if( actor == 1006568 && player.getQuestUI8AL( getId() ) != 1 )
        {
          if( flag )
            Scene00018( player );
          else
        ...
        if( actor == 1006569 && player.getQuestUI8BH( getId() ) != 1 )
        {
          if( flag )
            Scene00021( player );
          else
      ...
      case 3:
      {
        if( actor == 1007611 && player.getQuestUI8AL( getId() ) != 1 )
        {
          if( flag )
            Scene00024( player );
          else
...
player.sendDebug( "questId: {}, calling Empty:Scene00006 ACTOR5:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:CombinedCutScene](7)CutScene:Scene00008 ACTOR6", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](9)Talk:Scene00010 ACTOR7:UI8BL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00013 ACTOR8", getId() );
...
{
  player.sendUrgent( "ItemId: 6223, 6224" );
}
    };
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](14)Talk:Scene00015 ACTOR9:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](16)Talk:Scene00017 ACTOR10:UI8BH=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](18)Talk:Scene00019 ACTOR11:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00021 ACTOR6", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00022 ACTOR8", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00023 +1 ", getId() );
...
player.sendDebug( "questId: {}, calling [sub:BranchTrue](23)Talk:Scene00024 ACTOR12:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling Empty:Scene00028 EOBJECT0:UI8AL=-2, 1", getId() );
...
player.sendDebug( "questId: {}, calling Talk:Scene00032 ACTOR13", getId() );
...
player.sendDebug( "questId: {}, calling Empty:Scene00033 ACTOR14", getId() );
