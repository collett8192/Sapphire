...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 4293212 || param2 == 4293212 ) // EVENTRANGE0 = unknown
        {
        ...
        if( param1 == 2002157 || param2 == 2002157 ) // EOBJECT0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 2 )
          {
        ...
        if( param1 == 4293210 || param2 == 4293210 ) // ENEMY0 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 4293211 || param2 == 4293211 ) // ENEMY1 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 2002513 || param2 == 2002513 ) // EOBJECT1 = unknown
        {
      ...
      case 255:
      {
        if( type != 2 ) Scene00009( player ); // Scene00009: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=NIVIE
        break;
      }
      default:
      {
...
private:
  ...
  {
    player.sendDebug( "GaiUsb903:66462 calling Scene00004: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
  ...
  {
    player.sendDebug( "GaiUsb903:66462 calling Scene00006: Normal(None), id=unknown" );
    checkProgressSeq1( player );
  }
