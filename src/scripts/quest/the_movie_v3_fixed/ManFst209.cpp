...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 1004584 || param2 == 1004584 ) // ACTOR1 = FLAMESGT
        {
        ...
        if( param1 == 1004585 || param2 == 1004585 ) // ACTOR2 = unknown
        {
          Scene00003( player ); // Scene00003: Normal(None), id=unknown
          break;
        }
        if( param1 == 1004586 || param2 == 1004586 ) // ACTOR3 = unknown
        {
          Scene00004( player ); // Scene00004: Normal(None), id=unknown
          break;
        }
        if( param1 == 1004587 || param2 == 1004587 ) // ACTOR4 = unknown
        {
          Scene00005( player ); // Scene00005: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005161 || param2 == 1005161 ) // ACTOR5 = unknown
        {
      ...
      case 2:
      {
        if( param1 == 2001592 || param2 == 2001592 ) // EOBJECT0 = unknown
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
      ...
      case 3:
      {
        if( param1 == 1005017 || param2 == 1005017 ) // ACTOR6 = FLAMESGT
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
            Scene00014( player ); // Scene00014: Normal(Talk, Message, TargetCanMove), id=FLAMESGT
          }
          break;
        }
        if( param1 == 1004605 || param2 == 1004605 ) // ACTOR7 = FLAMEPRIVATE2
        {
          Scene00015( player ); // Scene00015: Normal(Talk, TargetCanMove), id=FLAMEPRIVATE2
          break;
        }
        if( param1 == 1004606 || param2 == 1004606 ) // ACTOR8 = unknown
        {
          Scene00016( player ); // Scene00016: Normal(None), id=unknown
          break;
        }
        if( param1 == 1004608 || param2 == 1004608 ) // ACTOR9 = FLAMEPRIVATE
        {
          Scene00017( player ); // Scene00017: Normal(Talk, TargetCanMove), id=FLAMEPRIVATE
          break;
        }
        if( param1 == 1004610 || param2 == 1004610 ) // ACTOR10 = AMALJA
        {
          Scene00018( player ); // Scene00018: Normal(Talk, TargetCanMove), id=AMALJA
          break;
        }
        if( param1 == 1004611 || param2 == 1004611 ) // ACTOR11 = unknown
        {
          Scene00019( player ); // Scene00019: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005140 || param2 == 1005140 ) // ACTOR12 = unknown
        {
          Scene00020( player ); // Scene00020: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005141 || param2 == 1005141 ) // ACTOR13 = unknown
        {
          Scene00021( player ); // Scene00021: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005142 || param2 == 1005142 ) // ACTOR14 = unknown
        {
          Scene00022( player ); // Scene00022: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005143 || param2 == 1005143 ) // ACTOR15 = unknown
        {
          Scene00023( player ); // Scene00023: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005144 || param2 == 1005144 ) // ACTOR16 = unknown
        {
          Scene00024( player ); // Scene00024: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005145 || param2 == 1005145 ) // ACTOR17 = unknown
        {
          Scene00025( player ); // Scene00025: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005018 || param2 == 1005018 ) // ACTOR18 = ADALA
        {
      ...
      case 4:
      {
        if( param1 == 1004605 || param2 == 1004605 ) // ACTOR7 = FLAMEPRIVATE2
        {
          Scene00027( player ); // Scene00027: Normal(Talk, TargetCanMove), id=FLAMEPRIVATE2
          break;
        }
        if( param1 == 1004606 || param2 == 1004606 ) // ACTOR8 = unknown
        {
        ...
        if( param1 == 1004608 || param2 == 1004608 ) // ACTOR9 = FLAMEPRIVATE
        {
          Scene00029( player ); // Scene00029: Normal(Talk, TargetCanMove), id=FLAMEPRIVATE
          break;
        }
        if( param1 == 1004610 || param2 == 1004610 ) // ACTOR10 = AMALJA
        {
          Scene00030( player ); // Scene00030: Normal(Talk, TargetCanMove), id=AMALJA
          break;
        }
        if( param1 == 1004611 || param2 == 1004611 ) // ACTOR11 = unknown
        {
        ...
        if( param1 == 1005017 || param2 == 1005017 ) // ACTOR6 = FLAMESGT
        {
          Scene00032( player ); // Scene00032: Normal(Talk, TargetCanMove), id=FLAMESGT
          break;
        }
        if( param1 == 1005140 || param2 == 1005140 ) // ACTOR12 = unknown
        {
      ...
      case 5:
      {
        if( param1 == 1005156 || param2 == 1005156 ) // ACTOR20 = THANCRED
        {
          if( player.getQuestUI8AL( getId() ) != 1 )
          {
        ...
        if( param1 == 1005146 || param2 == 1005146 ) // ACTOR21 = unknown
        {
          Scene00041( player ); // Scene00041: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005147 || param2 == 1005147 ) // ACTOR22 = unknown
        {
          Scene00042( player ); // Scene00042: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005148 || param2 == 1005148 ) // ACTOR23 = unknown
        {
          Scene00043( player ); // Scene00043: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005149 || param2 == 1005149 ) // ACTOR24 = unknown
        {
          Scene00044( player ); // Scene00044: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005150 || param2 == 1005150 ) // ACTOR25 = unknown
        {
          Scene00045( player ); // Scene00045: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005151 || param2 == 1005151 ) // ACTOR26 = unknown
        {
          Scene00046( player ); // Scene00046: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005152 || param2 == 1005152 ) // ACTOR27 = unknown
        {
          Scene00047( player ); // Scene00047: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005153 || param2 == 1005153 ) // ACTOR28 = unknown
        {
          Scene00048( player ); // Scene00048: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005154 || param2 == 1005154 ) // ACTOR29 = unknown
        {
          Scene00049( player ); // Scene00049: Normal(None), id=unknown
          break;
        }
        if( param1 == 1005155 || param2 == 1005155 ) // ACTOR30 = unknown
        {
      ...
      case 255:
      {
        if( param1 == 1005012 || param2 == 1005012 ) // ACTOR31 = GUIDE
        {
...
private:
  ...
  void Scene00008( Entity::Player& player )
  {
    ...
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
        ...
        pTeriMgr.createAndJoinQuestBattle( player, 45 );
      }
    };
  ...
  {
    player.sendDebug( "ManFst209:65879 calling Scene00014: Normal(Talk, Message, TargetCanMove), id=FLAMESGT" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      player.setQuestUI8AL( getId(), 1 );
  ...
  void Scene00039( Entity::Player& player )
  {
    ...
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
        player.sendUrgent( "use duty finder" );
      }
    };
