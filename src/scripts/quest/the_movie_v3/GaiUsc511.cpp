...
private:
  void onProgress( Entity::Player& player, uint64_t param1, uint32_t param2, uint32_t type, uint32_t param3 )
  {
    switch( player.getQuestSeq( getId() ) )
    {
      ...
      case 1:
      {
        if( param1 == 2002214 || param2 == 2002214 ) // EOBJECT0 = unknown
        {
        ...
        if( param1 == 2002215 || param2 == 2002215 ) // EOBJECT1 = unknown
        {
        ...
        if( param1 == 2002216 || param2 == 2002216 ) // EOBJECT2 = unknown
        {
        ...
        if( param1 == 2002217 || param2 == 2002217 ) // EOBJECT3 = unknown
        {
        ...
        if( param1 == 2002218 || param2 == 2002218 ) // EOBJECT4 = unknown
        {
        ...
        if( param1 == 2002219 || param2 == 2002219 ) // EOBJECT5 = unknown
        {
        ...
        if( param1 == 2002220 || param2 == 2002220 ) // EOBJECT6 = unknown
        {
        ...
        if( param1 == 2002221 || param2 == 2002221 ) // EOBJECT7 = unknown
        {
...
private:
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00001: Normal(Talk, QuestAccept, TargetCanMove), id=AGANBOLD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00003: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00005: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00007: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00009: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00011: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00013: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00015: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00017: Normal(None), id=unknown" );
  ...
  {
    player.sendDebug( "GaiUsc511:66535 calling Scene00019: Normal(Talk, QuestReward, QuestComplete, TargetCanMove), id=AGANBOLD" );
    auto callback = [ & ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.param1 > 0 && result.param2 == 1 )
      {
